      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_section/insert" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="form-group sublst" id="sub1">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="section_name[]" id="section_name1" class="form-control subtype" placeholder="Input Subject Name" value="" >
