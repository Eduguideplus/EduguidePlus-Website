...
<div id="validation" style="color:red;"></div>
 ...
 <h4 style="text-align:center;">PAGE MANAGE</h4> <p></p>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="radio" id="page_type" name="page_type[]"  class="span7" value="static"  onclick="static_page_function(this.value)" <?php if($this->session->flashdata('page_type')=='static') { ?>checked="checked"<?php } ?><?php if($this->session->flashdata('page_type')=='') { ?>checked="checked"<?php } ?> />Static
                 <input type="radio" id="page_type" name="page_type[]"  class="span7" value="dyanamic"  onclick="static_page_function(this.value)" <?php if($this->session->flashdata('page_type')=='dyanamic') { ?>checked="checked"<?php } ?>/>Dyanamic
