        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Upload Helpdesk</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
         <div style="padding-left: 12px;"><?php echo $this->session->flashdata('msg'); ?></div>
            
            <form id="form" name="form" class="form-horizontal" action="<?php echo base_url();?>index.php/helpdesk/add_submit" method="post" enctype='multipart/form-data'>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="name" class="form-control" id="tittle" name="tittle" placeholder="Tittle">
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="file" class="form-control" name="help_file" id="help_file">
                      </div>
                </div>
...
<script src="<?php echo base_url();?>custom_script/setting_validation.js"></script>
 ...
 <script type="text/javascript">
    ...
    function add_Submit()
    {
      ...
      var help_file = $("#help_file").get(0).files.length;
    
      if(help_file=='')
      {
        
        $('#help_file').removeClass('black_border').addClass('red_border');
      }
      else
      {
        
        $('#help_file').removeClass('red_border').addClass('black_border');
      }
