        ...
        <div class="col-md-12">
          <!-- Horizontal Form -->
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_head_faculty/update_password" method="post" id="head_fclt_form_validation" enctype="multipart/form-data" >
                      <div class="box-body">
...
<script type="text/javascript">
   function validation()
    ...
    {
         $('#head_fclt_form_validation').attr('onchange', 'validation()');
         $('#head_fclt_form_validation').attr('onkeyup', 'validation()');
         $('#head_fclt_form_validation').attr('onfocus', 'validation()');

              validation();

              if ($('#head_fclt_form_validation .red_border').size() > 0)
              {
                $('#head_fclt_form_validation .red_border:first').focus();
                return false;
              }
              else 
              {
                $('#head_fclt_form_validation').submit();
              }       
    }
 </script>
