          ...
          <!-- Horizontal Form -->
                <div class="box box-info">
                  <div class="box-header with-border">
                    <h3 class="box-title">Head Faculty Add</h3>
                    <div id="validation" style="color:red;"></div>
                  </div>
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal m_changes" action="<?php echo base_url();?>index.php/manage_head_faculty/insert" method="post" id="head_faculty_form_validation" enctype="multipart/form-data" >
         ...
         $('#head_faculty_form_validation').attr('onfocus', 'validation()');
              ...
              else 
              {
                var base_url="<?php echo base_url(); ?>";
                 ...
                 $.ajax({
                   url:base_url+'index.php/manage_head_faculty/check_exist_mail',
                   data:{email:email},
                   dataType:'json',
                   type:'post',
                   success: function(data)
                   {
                     ...
                     else 
                     {
                       ...
                       $('#error_email').html('');
                        ...
                        $.ajax({
                           url:base_url+'index.php/manage_head_faculty/check_exist_mobile',
                           data:{mobile:mobile},
                           dataType:'json',
                           type:'post',
                           success: function(data)
