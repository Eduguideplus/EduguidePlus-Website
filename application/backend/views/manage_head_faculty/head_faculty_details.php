          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_career/insert" method="post" id="add" enctype="multipart/form-data" >
              <div class="box-body">
                  ...
                  <img src="<?php echo base_url()."../assets/uploads/head_faculty/".@$user_details[0]->profile_photo;?>" style="height:90px;width:90px"></img> 
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-2 control-label">Partner Name</label>

                  <div class="col-sm-10">
                   <input type="text"  class="form-control" value="<?php echo @$partner[0]->user_name;?>" readonly>
                     <span id="error_catname" style="color:red"></span>
                  </div>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_head_faculty/list_view" class="btn btn-danger">BACK</a>
