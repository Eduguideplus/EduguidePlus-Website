              ...
              <div class="box-body">
                <span style="color: rgb(255, 0, 0); padding-left: 2px;">(* fields are required)</span>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <textarea type="text" name="question" class="form-control" id="question" rows="4" cols="50" ><?php echo $faq_data[0]->faq_question;?></textarea>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                       <textarea type="text" name="answer" class="form-control" id="answer" rows="4" cols="50" style="height:200px;" ><?php echo $faq_data[0]->faq_answer;?></textarea>
