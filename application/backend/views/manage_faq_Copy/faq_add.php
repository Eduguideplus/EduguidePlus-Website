            ...
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_faq/insert" method="post" id="faqadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                <span style="color: rgb(255, 0, 0); padding-left: 2px;">(* fields are required)</span>
                  ...
                  <div class="col-sm-10">
                   <textarea type="text" name="question" class="form-control" id="question" rows="4" cols="50" ></textarea>
                  ...
                  <div class="col-sm-10">
					             <textarea type="text" name="answer" class="form-control" id="answer" rows="4" cols="50" style="height:200px;"></textarea>
