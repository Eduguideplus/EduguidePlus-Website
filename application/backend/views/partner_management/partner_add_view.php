      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/partner_management/partner_insert" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <!--  <div class="form-group">
              ...
              <div class="form-group" id="fl">
                  <label for="class" class="col-sm-2 control-label">Partner Photo(200x200px)<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                  <div class="col-sm-8" >
                    <input type="file" name="partner_photo" id="partner_photo" class="form-control" >
...
<script>
  function validation()
  {
      ...
      var partner_photo = $('#partner_photo').val();
      if (!isNull(partner_photo)) {
        $('#partner_photo').removeClass('black_border').addClass('red_border');
      } else {
        $('#partner_photo').removeClass('red_border').addClass('black_border');
      }
  }
