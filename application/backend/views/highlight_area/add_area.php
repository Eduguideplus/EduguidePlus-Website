      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box-header with-border">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/Highlight_area/insert" method="post" id="add_page" enctype='multipart/form-data'>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <textarea id="area"  name="area"  class="form-control" style="height:100px"></textarea>
                  </div>
