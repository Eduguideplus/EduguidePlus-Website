            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form name="main" id="add" action="<?php echo base_url(); ?>index.php/manage_our_services_approach/edit_submit" role="form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                
                                <div class="form-group" style="margin-top: 10px;">
                                    <label for="img_upload" class="col-sm-2 control-label text-center">Image(125X125 px):</label>
                                    <div class="col-sm-6">
                                        ...
                                        if($data_info[0]->image!="")
                                        {
                                            ?>
                                            <img id="prof_pic"
                                                 src="<?php echo base_url() ?>../assets/uploads/our_services_approach/<?php echo $data_info[0]->image; ?>"
