    ...
    <section class="content-header">
       ...
       <small><?php
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Our Services Approach</li>
        </ol>
    </section>
        ...
        <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                           ...
                           <h4 class="box-title" style="color:green"><b><u>Our Services Approach Content</u> :- </b></h4>
                        </div>
            ...
            if($succ_delete){
              ...
              ?></small>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form name="main" id="main" action="<?php echo base_url(); ?>index.php/manage_our_services_approach/update" role="form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
            ...
            <div class="col-xs-12 table-responsive">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><b><u style="color:green">Our Services Approach List</u> :- </b></h3>
                    </div>
                    <div class="col-md-12" style="">


                            <button type="button" class="btn btn-primary" onClick="window.location='<?php echo base_url();?>index.php/manage_our_services_approach/add_view';"><span class="glyphicon glyphicon-plus"></span>Add</button>
                ...
                <a href="javascript:void(0)" class="btn btn-danger btn-action" title="Inactive" onclick="change_sts_active('inactive')"><i class="fa fa-pencil-square-o" ></i> Inactive</a>
                  ...
                  <?php
                                    ...
                                    <td><img src="<?php echo base_url();?>../assets/uploads/our_services_approach/<?php  echo $slider->image; ?>" width="150" height="64"></td>
                                    <td><?php echo @$slider->title; ?></td>
                                    <td><?php echo substr(strip_tags(@$slider->content),0,80) ;?></td>
                                    
                                    <td>
                                        <a href="<?php echo base_url()?>index.php/manage_our_services_approach/edit_view/<?php echo $slider->id; ?>" class="btn-primary btn-sm" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                         <a href="<?php echo base_url()?>index.php/manage_our_services_approach/delete_data/<?php echo $slider->id; ?>" class="btn-danger btn-sm" name="" id="" onclick="return confirm('Are you sure ?')" title="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
  ...
  <script type="text/javascript">
        ...
        function change_sts_active(val)
        {
            ...
            $.ajax({
             ...
             url:base_url+'index.php/manage_our_services_approach/change_to_active',
