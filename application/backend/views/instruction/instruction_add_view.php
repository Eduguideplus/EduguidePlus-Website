<!-- <script src='//cdn.tinymce.com/4/tinymce.min.js'></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ADD INSTRUCTION FOR EXAMINATION
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_instruction/insert_instruction" method="post" id="instruct" >
              <div class="box-body">
             ...
             <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="ins_title" class="form-control" id="ins_title" placeholder="Instruction Title."  value="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <textarea type="text" name="ins_dtls" id="inst_dtls" class="form-control tinyarea"  style="resize:none;height:90px" > </textarea>
                    <span id="error_dtls" style="color:red"></span>
                  </div>
