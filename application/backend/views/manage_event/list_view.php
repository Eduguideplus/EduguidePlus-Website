            ...
            <div class="col-xs-12 table-responsive">
                <div class="box">
                    <div class="box-header">
                           <h3 class="box-title">All Event  List(<?php echo count($tender);?>)</h3>
                    </div>
            ...
            if($succ_update){
              ...
              ?></small>
                    ...
                    <div class="col-md-12" style="">
                        ...
                        <a href="<?php echo base_url()?>index.php/manage_event/add_view" class="btn btn-info btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
          ...
          <a href="javascript:void(0)" class="btn btn-danger btn-action" title="Inactive" onclick="change_sts_active('inactive')"><i class="fa fa-pencil-square-o" ></i> Inactive</a>
            ...
            <div class="clearfix"></div>        
                  ...
                  <?php
                         ...
                         <td>
                           ...
                           if($row->image!='')
                            {
                              ?>
                         <embed style="height: 60px; width: 70px;" src="<?php echo base_url(); ?>../assets/uploads/event/<?php echo $row->image; ?>"></embed>
                         <?php
                       }
                       else{
                ...
                <td>
                       ...
                       <a href="<?php echo base_url()?>index.php/manage_event/edit_tender/<?php echo $row->id; ?> " class="btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
 ...
 <script type="text/javascript">
   ...
   <script type="text/javascript">
          function delete_data(id)
          {
            ...
            {
                window.location.href="<?php echo base_url();?>index.php/manage_event/delete_tender/"+id;
            }
          }
...
$.ajax({
              ...
              url:base_url+'index.php/manage_event/change_home_status',
              data:{cid:id},
              dataType: "json",
              type: "POST",
              success: function(data){
