      ...
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <div style="padding-left: 12px;"><?php echo $this->session->flashdata('msg'); ?></div>
            ...
            <form id="add" name="form" class="form-horizontal" action="<?php echo base_url();?>index.php/manage_event/edit_tender_submit" method="post" enctype='multipart/form-data'>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">File :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                    ...
                    <div class="col-sm-9" >
                       ...
                       <embed style="height: 50px; width: 60px;" src="<?php echo base_url() ?>../assets/uploads/event/<?php echo @$tender[0]->image ?>"></embed>
                       <?php
                     }
                     else{
                      echo "Previouly no file uploaded"; 
                     }
                     ?>
             ...
             <span style="color: rgb(255, 0, 0); padding-left: 2px;">* fields are required</span>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_event/list_view" class="btn btn-danger fa fa-backward"><b>  Back</b></a>
