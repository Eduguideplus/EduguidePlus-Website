          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/profile/profile_update" method="post" id="profileedit_form_validation" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="f_name" id="f_name"class="form-control" id="inputName" placeholder="Name" value="<?php echo $profile[0]->user_name; ?>">
              ...
              <input type="hidden" name="userid" value="<?php echo $profile[0]->id; ?>">
              <div id="error"></div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="<?php echo base_url();?>" class="btn btn-danger">Cancel</a>
                <button type="submit" class="btn btn-info pull-right" onclick="return exequete_profileedit_form_validation()">Submit</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
