<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/manage_documents/view_documents">Study Material</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Student's Kit(<?php echo count(@$material);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_documents/documents_add" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add </a></td>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               ?>
                ...
                <td><?php if(@$row->material_file!=''){?><a href="<?php echo base_url();?>../assets/uploads/material/<?php echo @$row->material_file; ?>" target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a><?php }else{?><iframe width="150" height="100" src="<?php echo @$row->video_link; ?>"></iframe><?php }?></td>
                  ...
                  <td> <a href="<?php echo base_url();?>index.php/manage_documents/documents_edit/<?php echo $row->id;?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
                    <a  href="<?php echo base_url(); ?>index.php/manage_documents/delet_study_mat/<?php echo $row->id; ?>" class="btn btn-danger" title="Delete"><i class="fa fa-trash-o"></i></a></td>
                </tr>
   ...
   function change_sts_active(val)
        {
           ...
           // alert('ok');
             ...
             url:base_url+'index.php/manage_documents/change_to_active',
