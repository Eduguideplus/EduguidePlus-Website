...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_rm/view_rm',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
...
<?php } ?>
 ...
 $admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_chapters/view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_test_type/view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_institution/inst_level',get_cookie('session_user_id'))=='Y' || @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_institution/inst_list',get_cookie('session_user_id'))=='Y'|| @$admin_details[0]->user_type_id==1)
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_institution/inst_level',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_top_college/index',get_cookie('session_user_id'))=='Y' || @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_top_college/inst_list',get_cookie('session_user_id'))=='Y'|| @$admin_details[0]->user_type_id==1)
    { ?>

          <li class="treeview <?php if($controller=='home1' || $controller=='manage_top_college'){ echo 'active'; } ?>" >
          <a href="#">
            <i class="fa fa-th-large"></i>
            <span> TOP COLLEGE MANAGEMENT </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_top_college/index',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>


       <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>index.php/manage_top_college/index"><i class="fa fa-list"></i>Manage Top College Header</a>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_top_college/inst_list',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>

 <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>index.php/manage_top_college/inst_list"><i class="fa fa-list"></i>Manage Top College</a>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_question/view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1 || @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_media_question/get_media',get_cookie('session_user_id'))=='Y')
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_media_question/get_media',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
            <ul class="treeview-menu">
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_study_abroad/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1 )
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('  manage_schedule_to_meet/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1 )
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_testimonials/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_video_tutorial_category/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1 || @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_video_tutorial/list_view',get_cookie('session_user_id'))=='Y' )
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
     ...
     //print_r($admin_details);exit;
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_video_tutorial_category/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('welcome_content/content_view',get_cookie('session_user_id'))=='Y' || 
      
      @$admin_details[0]->user_type_id==1 || 

      @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_why_us/why_us_view',get_cookie('session_user_id'))=='Y' ||

       @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_new_notice/list_view',get_cookie('session_user_id'))=='Y' || 

       @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_event/list_view',get_cookie('session_user_id'))=='Y' ||

        @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('training_slider/view_training_slider',get_cookie('session_user_id'))=='Y' || 

        @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('home/index',get_cookie('session_user_id'))=='Y' || 

        @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('partner_management/view_partner',get_cookie('session_user_id'))=='Y' ||

         @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_our_experties/list_view',get_cookie('session_user_id'))=='Y' || 

         @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('social_site/view',get_cookie('session_user_id'))=='Y' ||

         @$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('contact/contact_view',get_cookie('session_user_id'))=='Y')
      { 
      ?>    
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('home/index',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_our_experties/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('partner_management/view_partner',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('training_slider/view_training_slider',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('social_site/view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('contact/contact_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('welcome_content/content_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_why_us/why_us_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_new_notice/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('manage_event/list_view',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { 
      ?>
...
$admin_details=$this->session_check_and_session_data->admin_session_data();
    ...
    if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('page_list_manage/index',get_cookie('session_user_id'))=='Y' || @$admin_details[0]->user_type_id==1)
    { ?>    
