      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/terms/update" method="post" id="add" >
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea type="text" name="terms_content" id="terms_content" class="tinyarea" placeholder="" value="" rows="20" cols="10"><?php echo @$terms_content[0]->term_content;?></textarea>
                    
                  </div>
                 
              </div>

              <input type="hidden" value="<?php echo @$terms_content[0]->term_id;?>" name="edit_id" >
