<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/index.php/sub_admin_list_manage">Sub-Admin List</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Sub-Admin(<?php echo count($sub_admin_list ); ?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/sub_admin/add_sub_admin" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add Sub-Admin</a></td>
 ...
 -->
            ...
            if(count($sub_admin_list )>0)
            {
                ...
                <td><?php if(!empty($row->login_pass)){ echo $row->login_pass;}else{ echo $emptyString;}?></td>  
                  <td>
