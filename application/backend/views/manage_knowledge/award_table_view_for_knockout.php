        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Awarded User(<?php echo count($rank_data);?>)</h3>
            </div>
            <!-- /.box-header -->
           ...
           <table width="100%">
            <tr>
              ...
              <td width="50%">  <a href="<?php echo base_url();?>index.php/manage_knowledge/next_level_list/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" class="btn btn-danger"><i class="fa fa-backward"></i> Back</a></td>
