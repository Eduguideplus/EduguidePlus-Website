    ...
    <section class="content-header">
     ...
     Winner View
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/manage_mock/mock_view">Winner View</a></li>
                ...
                <tbody>
                  ...
                  foreach($enroll_details as $row)
                  {
                    ...
                    <td><?php echo $user_details[0]->user_name;?></td>
                     ...
                     <td><?php echo @$rank_details[0]->total_marks;?></td>
                     <td><?php echo @$rank_details[0]->rank_index;?></td>
