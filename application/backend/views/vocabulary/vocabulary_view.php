  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="title1" class="form-control"  placeholder="Title1"  id="title1" value="WORD" readonly="">                   
                  </div>
      ...
      <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="description1" class="form-control"  placeholder="Description1"  id="description1" >  
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="title2" class="form-control"  placeholder="Title2"  id="title2" value="SYNONYMS" readonly="">                   
                  </div>
      ...
      <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="description2" class="form-control"  placeholder="Description2"  id="description2" >  
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="title3" class="form-control"  placeholder="Title3"  id="title3" value="ANTONYMS" readonly="">                   
                  </div>
      ...
      <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="description3" class="form-control"  placeholder="Description3"  id="description3" >  
                  </div>
