      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_gallery_category/edit_action" method="post" id="categoryadd_form_validation" enctype='multipart/form-data'>
              <div class="box-body">
               <span style="color: rgb(255, 0, 0); padding-left: 2px;">(* fields are required)</span>
                ...
                <div class="form-group">
                 <label for="inputUsername" class="col-sm-2 control-label">Choose Gallery Tag:<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
           
                          <div class="col-sm-9">
                               <select class="form-control" name="tag" id="tag">
                                <option  value="">select Tag</option>

                                <?php foreach ($tag_details as $category) { ?>
                               <option value="<?php echo $category->gallery_tag_id; ?>" <?php if($cat_details[0]->gallery_tag_id==$category->gallery_tag_id){echo 'selected';} ?> ><?php echo $category->gallery_tag_name; ?></option>
                                            <?php } ?>
              ...
              <div class="form-group">
                  <label for="category_name" class="col-sm-2 control-label">Album Title<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                  <div class="col-sm-8">
                    <input type="text" name="category_name" id="category_name" onkeyup="catname(this.value)" class="form-control" placeholder="Album Name" autocomplete="off" value="<?php echo $cat_details[0]->cat_name; ?>">
...
<div class="clearfix"></div> 
                             <div class="form-group" style="margin-top: 10px;">
                                    <label for="image" class="col-sm-2 control-label text-center">Album Image(375 X 250 px):<span style="color:#F00"></span></label>
                                    <div class="col-sm-7">
           ...
           <!--  <div class="clearfix"></div> 
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_gallery_category/category_list_view" class="btn btn-danger">Cancel</a>
  ...
  function get_subcategory(value)
{
  ...
  function product_Submit_fm()
  {
      ...
      var tag = $('#tag').val();
        if (!isNull(tag)) 
        {
          $('#tag').removeClass('black_border').addClass('red_border');
          return false;
        } 
        else 
        {
          $('#tag').removeClass('red_border').addClass('black_border');
        }
