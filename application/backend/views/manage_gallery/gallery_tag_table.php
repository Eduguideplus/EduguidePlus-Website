  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      <h3> GALLERY TAG
        ...
        <li class="active">Gallery Tag</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">All Tags(<?php echo count($category_details);?>)</h3>
            ...
            <button type="button" class="btn btn-primary" onClick="window.location='<?php echo base_url();?>index.php/manage_gallery_tag/add_view';"><span class="glyphicon glyphicon-plus"></span>Add New Tag</button>
              ...
              <table id="example1" class="table table-bordered table-striped myTable1">
               ...
               <tbody>
                     ...
                     if(count($category_details) > 0)
                    {
                     ...
                     ?>            
                    <tr>
                    <td><input type="checkbox" name="record" value="<?php echo $row->gallery_tag_id;?>"></td>
                    <td>
                  ...
                  <?php
                    ...
                    <td><?php if(!empty($row->gallery_tag_name)){ echo $row->gallery_tag_name; } else{ echo 'N/A'; } ?></td>
                    ...
                    <option><?php echo $row->sort_order;?></option>
                     ...
                     <?php } ?>
                        ...
                        <td>
                             ...
                             <a href="<?php echo base_url();?>index.php/manage_gallery_tag/get_edit_details/<?php echo $row->gallery_tag_id;?>" class="btn btn-info" ><i class="fa fa-pencil-square-o" title="edit"></i></a>

                               <?php  $gallery_details=$this->common->select($table_name ='tbl_gallery_category', $field = array(), $where = array('gallery_tag_id'=>@$row->gallery_tag_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');  

                            if(count($gallery_details)==0){

                            ?>

                             <a type="button" class="btn btn-danger" onclick="return delete_data('<?php echo $row->gallery_tag_id;?>')" ><i class="fa fa-trash-o" title="delete"></i></a>  <?php }?>
  ...
  <script type="text/javascript">
        ...
        function change_sts_active(val)
        {
            ...
            $.ajax({
             ...
             url:base_url+'index.php/manage_gallery_tag/change_to_active',
    ...
    if(confirm("Are you sure"))
      {
          ...
          window.location=baseurl+'index.php/manage_gallery_tag/delete_data/'+id;
