      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_gallery_category/insert_category" method="post" id="categoryadd_form_validation" enctype='multipart/form-data' >
              <div class="box-body">
        ...
        <div class="form-group">
                 <label for="inputUsername" class="col-sm-2 control-label">Choose Gallery Tag:<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                          ...
                          <div class="col-sm-9">
                               ...
                               <option value="<?php echo $category->gallery_tag_id; ?>"><?php echo $category->gallery_tag_name; ?></option>
                                            <?php } ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="category_name" id="category_name" onkeyup="catname(this.value)" class="form-control" placeholder="Album name" value=""  autocomplete="off">
