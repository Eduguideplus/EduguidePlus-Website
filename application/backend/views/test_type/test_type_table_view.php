<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/manage_subjects/view">Test Type</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Test Type(<?php echo count($tests);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_test_type/add" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add </a></td>
               ...
               ?>
                ...
                <tr>
                 ...
                 <!-- <td>
                  ...
                  <td><?php echo @$row->test_descpn;?></td>
                  <td><?php echo @$row->test_id;?></td>
                  <td> <a href="<?php echo base_url();?>index.php/manage_test_type/edit/<?php echo @$row->test_id;?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
                    <!-- <button type="button" class="btn btn-danger" onclick="return delete_data(<?php echo @$row->sub_id;?>)" title="Delete"><i class="fa fa-trash-o"></i></button> --></td>
                </tr>
