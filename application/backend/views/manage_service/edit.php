      ...
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <div style="padding-left: 12px;"><?php echo $this->session->flashdata('msg'); ?></div>
            ...
            <form id="add" name="form" class="form-horizontal" action="<?php echo base_url();?>index.php/manage_service/edit_tender_submit" method="post" enctype='multipart/form-data'>
              <div class="box-body">
                  ...
                  <label for="branch_address" class="col-sm-2 control-label">Title :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                    ...
                    <div class="col-sm-9" >
                      ...
                      <input type="text" class="form-control" name="service_title" id="service_title" required placeholder="Title*" value="<?php echo @$tender[0]->service_title; ?>">
                ...
                <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">Description :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                    <div class="col-sm-9" >
                      
                      
                       <textarea class="form-control" name="service_description" id="service_description" placeholder="" ><?php echo @$tender[0]->service_description; ?></textarea>
                ...
                <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$tender[0]->service_id; ?>">
             ...
             <span style="color: rgb(255, 0, 0); padding-left: 2px;">* fields are required</span>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_service/list_view" class="btn btn-danger fa fa-backward"><b>  Back</b></a>
