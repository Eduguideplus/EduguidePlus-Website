            ...
            <div class="col-xs-12 table-responsive">
                <div class="box">
                    <div class="box-header">
                           <h3 class="box-title">All Service  List(<?php echo count($tender);?>)</h3>
                    </div>
            ...
            if($succ_update){
              ...
              ?></small>
                    ...
                    <div class="col-md-12" style="">
                        ...
                        <a href="<?php echo base_url()?>index.php/manage_service/add_view" class="btn btn-info btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
            ...
            <div class="clearfix"></div>        
                                ...
                                if(count($tender) > 0)
                    {
                              foreach ($tender as $row) { 
                               ...
                               <tr>
                    <td><input type="checkbox" name="record" value="<?php echo $row->service_id;?>"></td>
                    <td>
                ...
                <td>
                       ...
                       <a href="<?php echo base_url()?>index.php/manage_service/edit_tender/<?php echo $row->service_id; ?> " class="btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

                      
                          <button type="button" class="btn-btn btn-danger" onclick="return delete_data(<?php echo $row->service_id;?>)" title="Delete"><i class="fa fa-trash-o"></i> Delete</button>
 ...
 <script type="text/javascript">
         ...
         function change_sts_active(val)
        {
            ...
            $.ajax({
             ...
             url:base_url+'index.php/manage_service/change_to_active',
   ...
   <script type="text/javascript">
          function delete_data(id)
          {
            ...
            {
                window.location.href="<?php echo base_url();?>index.php/manage_service/delete_tender/"+id;
            }
          }
...
$.ajax({
              ...
              url:base_url+'index.php/manage_service/change_home_status',
              data:{cid:id},
              dataType: "json",
              type: "POST",
              success: function(data){
