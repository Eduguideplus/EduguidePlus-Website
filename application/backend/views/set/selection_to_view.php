      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_set/show_set_details" method="post" id="chk_set" enctype="multipart/form-data">
              <div class="box-body">
          ...
          <!--     <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-left" onclick="return form_validation()">Submit</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
