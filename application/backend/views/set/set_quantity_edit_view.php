      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_set/update_quantity" method="post" id="edit" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <!--  <div class="form-group">
              ...
              <input type="hidden" value="<?php echo @$set[0]->exam_id;?>" name="edit_id" >
              <div class="form-group">
                  <label for="" class="col-sm-2 control-label">Quantity(No. of Set)<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                  <div class="col-sm-9">
                    <input type="text"  name="qty" id="qty" class="form-control" value="<?php echo count($set); ?>">
