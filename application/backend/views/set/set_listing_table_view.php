...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       SET LISTING OF <?php echo @$exam_type[0]->exam_name; ?> 
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Set(<?php echo count($set_list);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"> <a href="<?php echo base_url();?>index.php/manage_set/set_view" class="btn btn-danger" title="Back"><i class="fa fa-backward"></i> Back </a> </td>
               ...
               ?>
                ...
                <tr>
                 <!--<td><input type="checkbox" name="record" value="<?php echo $row->id;?>"></td>-->
                  ...
                  ?></td>
                  <td> <?php  ?></td>
                  <td> <a href="<?php echo base_url();?>index.php/manage_set/view_details/<?php echo $row->id;?>" class="btn btn-info btn-action" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
