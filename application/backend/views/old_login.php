		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
                    ...
                    <?php echo form_open('index.php/login/login_check', array('class' => 'form-horizontal', 'id' => 'authenticate')); ?>
					
						<fieldset>
							<div class="input-prepend" title="Username" data-rel="tooltip">                           
								<span class="add-on"><i class="icon-user"></i></span>
                                <input autofocus class="input-large span10" name="username" id="username" type="text" placeholder="Username" />
							 	<div style="color:#F00;"><?php echo $this->session->flashdata('login_user'); ?></div>
                            </div>
							...
							<div class="input-prepend" title="Password" data-rel="tooltip">                            
								...
								<div style="color:#F00;"><?php echo $this->session->flashdata('login_password'); ?></div>
                            </div>
							<div class="clearfix"></div>

							<div class="input-prepend">
							<a href="<?php echo base_url(); ?>index.php/forget_password" style="cursor:pointer">Forget Password</a>
							</div>
							<div class="clearfix"></div>
