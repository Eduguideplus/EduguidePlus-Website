<script src='//cdn.tinymce.com/4/tinymce.min.js'></script>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_video_tutorial_category/update" method="post" id="testiadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                ...
                <input type="hidden" name="testid" value="<?php echo @$test_data[0]->category_id; ?>">
 ...
 -->
                  <div class="form-group">
                  <label for="gal_description" class="col-sm-2 control-label">Image <br>( 70 X 70 Pixel )</label>
                  ...
                  <div class="col-sm-8">
                   ...
                   <br>
                    <?php if(@$test_data[0]->image  !=''){ ?>
                        <img id="prof_pic" src="<?php echo base_url();?>../assets/uploads/video_tutorial_category/<?php echo @$test_data[0]->image; ?>" height="100px" width="100px" style="border-radius: 50%">
                    <?php } else { ?>
                ...
                <div class="form-group">
                  <label for="news_details" class="col-sm-2 control-label">Description</label>
