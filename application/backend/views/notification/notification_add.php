      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_notification/insert_notification" method="post" id="faqadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                <span style="color: rgb(255, 0, 0); padding-left: 2px;">(* fields are required)</span>
                  ...
                  <div class="col-sm-10">
                   <input type="text" name="n_text" id="n_text" class="form-control"  >
                  ...
                  <div class="col-sm-10">
					             <input type="text" name="n_link" class="form-control" id="n_link" >
