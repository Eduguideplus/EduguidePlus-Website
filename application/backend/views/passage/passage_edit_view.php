      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_passage/update" method="post" id="edit" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="passage_title" id="passage_title" class="form-control" placeholder="Input section Name" value="<?php echo $passage[0]->title; ?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea  name="passage_description" id="passage_description" class="form-control tinyarea" ><?php echo $passage[0]->description; ?></textarea>
                    
                  </div>
                 
              </div>

              <input type="hidden" value="<?php echo @$passage[0]->id;?>" name="edit_id" >
