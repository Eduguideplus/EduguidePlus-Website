        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Request(<?php echo count($request);?>)</h3>
            </div>
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               ?>
                ...
                <tr>
                  ...
                  <td><?php echo @$exam_dtls[0]->created_on; ?></td>
                 
                  <td><?php echo @$row->reason;?></td>
                  <td><span id="stat"> <a href="javascript:void(0)" class="btn btn-info btn-action" title="View" onclick="change_status('<?php echo @$row->status;?>','<?php echo @$row->id;?>');"><?php echo @$row->status;?></a></span>
                 </td>
                </tr>
