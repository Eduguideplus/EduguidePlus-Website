      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info" style="display:table;">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/Subadmin_question_price/question_price_insert" method="post" id="single_question_add" enctype="multipart/form-data">
            <div class="col-md-12">
              <div class="box-body">
