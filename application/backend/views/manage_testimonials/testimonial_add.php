      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_testimonials/insert" method="post" id="testiadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">

                  <div class="form-group" >
                    <label for="" class="col-sm-2 control-label">Name<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                      <div class="col-sm-8">
                        <input type="text" name="testname" class="form-control"  placeholder="Input Your Name"  id="testname" required="">
                  ...
                  <div class="form-group" id="tutor" >
                    <label for="profession" class="col-sm-2 control-label">Profession<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                      <div class="col-sm-8">
                          <input type="text" name="profession" class="form-control"  placeholder="Ex : Php Developer "  id="profession" >
                  ...
                  <div class="form-group">
                    <label for="image" class="col-sm-2 control-label">Image <br>( 100 X 100 Pixel )</label>
                    ...
                    <div class="col-sm-8">
                      <input type="file" name="image" class="form-control"  id="image">
					       ...
					       <div class="form-group">
                  <label for="content" class="col-sm-2 control-label">Testimonial Content<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
