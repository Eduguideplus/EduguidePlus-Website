            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url(); ?>index.php/coupon/coupon_submit" role="form" method="post" enctype="multipart/form-data" id="form1"> 
                            <div class="box-body">
                            <span id="msg" style="font-weight:bold;color:red"></span>
                                ...
                                <div class="form-group" style="margin-top: 10px">
                                 ...
                                 <div class="col-sm-7">
                                        <input type="text" class="form-control" name="max_user" id="max_user">
                                 ...
                                 <div class="col-sm-7">
                                       ...
                                       <div class="clearfix"></div>
                                       <div class="form-group" style="margin-top: 10px">
                                    <label for="fbook" class="col-sm-2 control-label text-center">Discount</label>
                                 <div class="col-sm-3">
                                            <select class="form-control" name="discount" id="discount" onchange="myFunction()">
                    ...
                    <option value="percentage">Percentage</option>
                                      ...
                                      <div class="col-sm-4">
                                       <input type="text" class="form-control" name="discount_amount" id="discount_amount" placeholder="Enter Amount">
                                        <input type="text" class="form-control" name="discount_per" id="discount_per" style="display:none" placeholder="Enter Percentage">
                                ...
                                <div class="form-group" style="margin-top: 10px">
                                 ...
                                 <div class="col-sm-3">
                                        <input type="text" class="form-control" name="valid_from" id="txtFrom">
                                     ...
                                     <div class="col-sm-1">
                                      ...
                                      <div class="col-sm-3">
                                        <input type="text" class="form-control" name="valid_to" id="txtTo">
