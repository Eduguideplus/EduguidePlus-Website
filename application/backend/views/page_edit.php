...
<section class="content">
 ...
 <h4 style="text-align:center;">PAGE MANAGE</h4> <p></p>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="radio" id="page_type" name="page_type[]"  class="span7" value="static"  onclick="static_page_function(this.value)" <?php if($page_details[0]->page_type=='static') { ?>checked="checked"<?php } ?><?php if($page_details[0]->page_type=='') { ?>checked="checked"<?php } ?> />Static
                 <input type="radio" id="page_type" name="page_type[]"  class="span7" value="dyanamic"  onclick="static_page_function(this.value)" <?php if($page_details[0]->page_type=='dyanamic') { ?>checked="checked"<?php } ?>/>Dyanamic
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="page_rout" class="form-control" name="page_rout" value="<?php echo $page_details[0]->controller; ?>"  readonly />
                  </div>
