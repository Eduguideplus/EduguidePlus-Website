      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_faq/update" method="post" id="faqedit_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                <span style="color: rgb(255, 0, 0); padding-left: 2px;">(* fields are required)</span>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <textarea type="text" name="question" class="form-control" id="question" rows="4" cols="50" required="" ><?php echo $faq_data[0]->faq_question;?></textarea>
                     <span id="error_catname" style="color:red"></span>
                  </div>
                  <input type="hidden" value="<?php echo $faq_data[0]->faq_id;?>" id="faq_id" name="faq_id" >
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                       <textarea type="text" name="answer" class="form-control" id="answer" rows="4" cols="50" style="height:200px;" required="" ><?php echo $faq_data[0]->faq_answer;?></textarea>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right" onclick="return faq_edit_validation()" >Update</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
...
<script type="text/javascript">
  ...
  function faq_edit_validation()
  {
  
   
    $('#faqedit_form_validation').attr('onchange', 'validation()');
    $('#faqedit_form_validation').attr('onkeyup', 'validation()');

     validation();
    //alert($('#contact_form .red_border').size());

    if ($('#faqedit_form_validation .red_border').size() > 0)
    {
      $('#faqedit_form_validation .red_border:first').focus();
      $('#faqedit_form_validation .alert-error').show();
      return false;
    } else {

      $('#faqedit_form_validation').submit();
    }
