      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_category/update" method="post" id="edit" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="col-sm-9">
                    ...
                    <option value="">Select</option>
                     <?php
                      ...
                      ?>
                      <option value="<?php echo $row->category_id; ?>"  <?php if($row->category_id==@$p_cat[0]->category_id){ echo 'selected';}?><?php if($row->category_id==@$m_cat[0]->category_id){ echo 'selected';}?> ><?php echo $row->category_name; ?></option>
                      <?php
                        }
                      ?>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="sub_category" id="sub_category" class="form-control"  >
                        ...
                        if(@$sub_cat[0]->category_id)
                        {
                        ?>
                        <option value="<?php echo @$sub_cat[0]->category_id; ?>"><?php echo @$sub_cat[0]->category_name; ?></option>
                        <?php } else { ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cat_name" id="cat_name" class="form-control" placeholder="" value="<?php echo @$category[0]->category_name;?>" >
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <?php foreach($practice  as $ptc){?>
                      <option value="<?php echo $ptc->id; ?>" <?php if($ptc->id==@$category[0]->exam_id){echo 'selected';} ?>><?php echo $ptc->exam_name; ?></option>
                      <?php } ?>
                    </select>
              ...
              <input type="hidden" value="<?php echo @$category[0]->category_id;?>" name="cat_edit_id" >
             ...
             <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="file" name="category_icon" id="category_icon" class="form-control" placeholder="" value="">
                    <input type="hidden" name="old_image" id="old_image" value="<?php echo @$category[0]->category_icon;?>" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="meta_tag" id="meta_tag" class="form-control" placeholder="" value="<?php echo @$category[0]->category_meta_title;?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="meta_desc" id="meta_desc" class="form-control" placeholder="" value="<?php echo @$category[0]->category_meta_description;?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="meta_key" id="meta_key" class="form-control" placeholder="" value="<?php echo @$category[0]->category_meta_keyword;?>">
              ...
              <!-- <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="sort_order" id="sort_order" class="form-control" placeholder="" value="<?php echo @$category[0]->category_sort_order;?>">
