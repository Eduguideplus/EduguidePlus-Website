        ...
        <div class="col-md-12">
          <!-- Horizontal Form -->
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_partner/update_password" method="post" id="partner_form_validation" enctype="multipart/form-data" >
                      <div class="box-body">
