        ...
        <div class="col-md-12">
          <!-- Horizontal Form -->
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal m_changes" action="<?php echo base_url();?>index.php/manage_faculty/insert" method="post" id="faculty_form_validation" enctype="multipart/form-data" >
         ...
         $('#faculty_form_validation').attr('onfocus', 'validation()');
              ...
              else 
              {
                var base_url="<?php echo base_url(); ?>";
                 ...
                 $.ajax({
                   url:base_url+'index.php/manage_faculty/check_exist_mail',
                   data:{email:email},
                   dataType:'json',
                   type:'post',
                   success: function(data)
                   {
                     ...
                     else 
                     {
                       ...
                       $('#error_email').html('');
                        ...
                        $.ajax({
                           url:base_url+'index.php/manage_faculty/check_exist_mobile',
                           data:{mobile:mobile},
                           dataType:'json',
                           type:'post',
                           success: function(data)
