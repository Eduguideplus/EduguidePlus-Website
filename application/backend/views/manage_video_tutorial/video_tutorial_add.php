      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_video_tutorial/insert" method="post" id="testiadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">
                ...
                <div class="form-group" >
                  ...
                  <div class="form-group" id="tutor" >
                    <label for="profession" class="col-sm-2 control-label">Video Link (Embed Link)<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                      ...
                      <div class="col-sm-8">
                          <input type="text" name="video_link" class="form-control"  placeholder="Video Link"  id="video_link" >
