            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url(); ?>index.php/manage_tax/tax_edit_submit" role="form" method="post" enctype="multipart/form-data" id="form1"> 
                            <div class="box-body">
                            <span id="msg" style="font-weight:bold;color:red"></span>
                                ...
                                <div class="form-group" style="margin-top: 10px">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="tax_name" id="tax_name" value="<?php echo $tax_dtls[0]->tax_name; ?>">
                                ...
                                <div class="form-group" style="margin-top: 10px">
                                 ...
                                 <div class="col-sm-7">
                                        <input type="text" class="form-control" name="tax_percentage" id="tax_percentage" value="<?php echo $tax_dtls[0]->tax_percentage; ?>">
                            ...
                            <input type="hidden" name="tax_id", value="<?php echo $this->uri->segment(3);?>">
                                 ...
                                 <div class="col-sm-7">
                                        ...
                                        <option value="active" <?php if($tax_dtls[0]->tax_status=='active'){echo 'selected'; }?> >Active</option>
                                        <option value="inactive" <?php if($tax_dtls[0]->tax_status=='inactive'){echo 'selected'; }?>>Inactive</option>
                                        </select>
