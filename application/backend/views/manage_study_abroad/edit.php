  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
       ...
       Edit Study Abroad Details
      </h3>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Edit Study Abroad Details</li>    
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <div style="padding-left: 12px;"><?php echo $this->session->flashdata('msg'); ?></div>
            ...
            <form id="add" name="form" class="form-horizontal" action="<?php echo base_url();?>index.php/manage_study_abroad/edit_tender_submit" method="post" enctype='multipart/form-data'>
              <div class="box-body">
              
                   <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">Country Name :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                    ...
                    <div class="col-sm-9" >
                     ...
                     <select class="form-control" name="country_name" id="country_name">
                      ...
                      { ?>
                       <option value="<?php echo @$row->id;?>" <?php if($row->id==@$tender[0]->country_name){echo 'selected';} ?>><?php echo @$row->name; ?></option>
                     <?php } ?>
                     </select>
                ...
                <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">Course Name :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                    ...
                    <div class="col-sm-9" >
                       ...
                       <textarea class="form-control" name="course_name" id="course_name" placeholder="" ><?php echo @$tender[0]->course_name; ?></textarea>
                ...
                <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">College Name :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                    ...
                    <div class="col-sm-9" >
                       ...
                       <textarea class="form-control" name="college_name" id="college_name" placeholder="" ><?php echo @$tender[0]->college_name; ?></textarea>
                ...
                <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$tender[0]->study_abroad_id; ?>">
             ...
             <span style="color: rgb(255, 0, 0); padding-left: 2px;">* fields are required</span>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_study_abroad/list_view" class="btn btn-danger fa fa-backward"><b>  Back</b></a>
