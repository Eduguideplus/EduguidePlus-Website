...
<div class="content-wrapper">
            ...
            <div class="col-xs-12 table-responsive">
                <div class="box">
                    <div class="box-header">
                           <h3 class="box-title">Total(<?php echo count($tender);?>)</h3>
                    </div>
            ...
            if($succ_update){
              ...
              ?></small>
                    ...
                    <div class="col-md-12" style="">
                        ...
                        <a href="<?php echo base_url()?>index.php/manage_study_abroad/add_view" class="btn btn-info btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
            ...
            <div class="clearfix"></div>        
                                ...
                                if(count($tender) > 0)
                    {
                              foreach ($tender as $row) { 
                               ...
                               <tr>
                    <td><input type="checkbox" name="record" value="<?php echo $row->study_abroad_id;?>"></td>
                    <td>
                  ...
                  <?php
                         ...
                         <?php 
                          $country_name= $this->common_model_order_by->common($table_name = 'countries', $field = array(), $where = array('id'=>$row->country_name), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
 ...
 <a href="<?php echo base_url()?>index.php/manage_study_abroad_fees/list_view/<?php echo $row->study_abroad_id; ?> " class="btn-sm btn-primary"><i class="fa fa-dollar" aria-hidden="true"></i> View</a>
                         </td>
                ...
                <td>
                       ...
                       <a href="<?php echo base_url()?>index.php/manage_study_abroad/edit_tender/<?php echo $row->study_abroad_id; ?> " class="btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

                      
                          <button type="button" class="btn-btn btn-danger" onclick="return delete_data(<?php echo $row->study_abroad_id;?>)" title="Delete"><i class="fa fa-trash-o"></i> Delete</button>
 ...
 <script type="text/javascript">
         ...
         function change_sts_active(val)
        {
            ...
            $.ajax({
             ...
             url:base_url+'index.php/manage_study_abroad/change_to_active',
   ...
   <script type="text/javascript">
          function delete_data(id)
          {
            ...
            {
                window.location.href="<?php echo base_url();?>index.php/manage_study_abroad/delete_tender/"+id;
            }
          }
...
$.ajax({
              ...
              url:base_url+'index.php/manage_study_abroad/change_home_status',
              data:{cid:id},
              dataType: "json",
              type: "POST",
              success: function(data){
