...
<head>
	...
	<title>Reply From Surajit Pramanick</title>
																...
																<table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
																	<tbody><tr>
																		<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																			...
																			<img align="center" alt="" src="https://www.Surajit Pramanick.com/assets/images/site-logo.png" width="200" style="max-width:369px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
																...
																<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																	<tbody><tr>
																		...
																		<td valign="top" class="mcnTextContent" >
																			...
																			New Set Created by Surajit Pramanick.&nbsp;<br>Please check given Details below :<br>
																				 <tr>
																			<td>&nbsp;&nbsp;&nbsp;</td>
																			</tr>
																			<tr><td>Test Type: <?php echo @$mail_data['test_type']; ?></td></tr>
																			<tr>

																		

																			<tr>
																			<td>Examination Group: <?php echo @$mail_data['exam_group']; ?></td>
																			</tr>

																			<tr>
																			<td> Examination Name: <?php echo @$mail_data['exam_name']; ?></td>
																			</tr>
																			
																			<tr>
																			<td>Subject Name: <?php echo @$mail_data['subject_name']; ?></td>
																		</tr>

																		<?php 
													@$chapter_name=@$mail_data['chapter_name'];
																		if(@$chapter_name!='')
																			{
																				?>

																		<tr>
																			<td>Chapter Name: <?php echo @$mail_data['chapter_name']; ?></td>
																		</tr>
																		<?php
																	}
																	?>
																		<tr>
																			<td>No. Of Question: <?php echo @$mail_data['no_of_question']; ?></td>
																		</tr>
																		<tr>
																			<td>Time/marks(Second): <?php echo @$mail_data['time_marks']; ?></td>
																		</tr>
																		<tr>
																			<td>Examination Date: <?php echo @$mail_data['exam_date']; ?></td>
																		</tr>
																		<tr>
																			<td>Examination Time: <?php echo @$mail_data['exam_time']; ?></td>
																		</tr>
																		<tr>
																			<td>Registration Start date: <?php echo @$mail_data['registation_start_date']; ?></td>
																		</tr>

																		<tr>
																			<td>Registration End Date: <?php echo @$mail_data['registation_end_date']; ?></td>
																		</tr>
																		<tr>
																			<td>Total Marks: <?php echo @$mail_data['total_marks']; ?></td>
																		</tr>

																		<tr>
																			<td>Exam Duration: <?php echo @$mail_data['exam_duration']; ?></td>
																		</tr>
																		<tr>
																			<td>Exam Fees: <?php echo @$mail_data['exam_fees']; ?></td>
																		</tr>
																			</tr>
																		</td></tr>
																	</tr>
																	<!-- <tr>
																		<td valign="top" ><a class="btn btn-success" style="background-color: #4CAF50; color: white;padding: 10px 12px; text-align: center;text-decoration: none;display: inline-block; font-size: 16px;margin: 20px;" href="<?php echo @$mail_data['v_link']; ?>">Activate Your Account</a></td>
																	</tr> -->
																	</tbody></table>
																<!--[if mso]>
																</td>
					...
					<tr>
						<td align="center" valign="top">
							...
							<em>Thanks and Regards,</em><br>
														Surajit Pramanick
												<br>
												<a href="https://www.Surajit Pramanick.com/">www.Surajit Pramanick.com</a>
												<br>
