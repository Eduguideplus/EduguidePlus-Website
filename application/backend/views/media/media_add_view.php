            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form name="main" id="main" action="<?php echo base_url(); ?>index.php/manage_media/media_add_submit" role="form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="page" id="page">
                                                ...
                                                <!-- <option value="Membership Objective">Membership Objective</option>
