            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form name="main" id="main" action="<?php echo base_url(); ?>index.php/manage_media/media_edit_submit" role="form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="clearfix"></div>
                                <div class="form-group" style="margin-top: 10px;">
                                    <label for="img_upload" class="col-sm-2 control-label text-center"> Page For</label>
                                    <div class="col-sm-4">
                                        <select class="form-control" name="page" id="page">
                                                <option value="">Select Page</option>
                                                <option value="About Us" <?php if(@$media[0]->page_name=='About Us'){ echo 'selected';}?>>About Us</option>
                                                <!-- <option value="Membership Objective" <?php if(@$media[0]->page_name=='Membership Objective'){ echo 'selected';}?>>Membership Objective</option>
                                                <option value="Membership Type" <?php if(@$media[0]->page_name=='Membership Type'){ echo 'selected';}?> >Membership Type</option>
                                                <option value="Souvenir" <?php if(@$media[0]->page_name=='Souvenir'){ echo 'selected';}?> >Souvenir</option>
                                                
                                                <option value="Activity" <?php if(@$media[0]->page_name=='Activity'){ echo 'selected';}?> >Activity</option> -->
                                        </select> 
