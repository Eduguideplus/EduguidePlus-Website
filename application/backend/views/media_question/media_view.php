        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <div class="box">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/manage_media_question/media_add" class="btn btn-sm btn-success" style="margin-left: 12px;"><i class="fa fa-plus" aria-hidden="true"></i> Add Media</a>
                        ...
                        <table id="example1" class="table table-bordered table-hover table-condensed table-responsive">
                            ...
                            <tr>
                               ...
                               <td><?php echo $i;?></td>
                                ...
                                <td>
                                    <?php
                                        if($row->media_filename!="")
                                        {
                                            ?>
                                            <img id="prof_pic"
                                                 src="<?php echo base_url() ?>../assets/uploads/media_question/<?php echo $row->media_filename; ?>"
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/manage_media_question/media_edit/<?php echo $row->media_id; ?>" class="btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

                                    <a href="<?php echo base_url(); ?>index.php/manage_media_question/media_delete/<?php echo $row->media_id; ?>" class="btn-sm btn-danger" onclick="return confirm('are you sure ?')"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a>
                                </td>
                            </tr>
                            <?php }?>
                            </tbody>
