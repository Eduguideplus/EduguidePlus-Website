      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_exam_time/insert" method="post" id="chk_set" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text"  name="markstime" id="markstime" class="form-control">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text"  name="negative_marks" id="negative_marks" class="form-control">
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_exam_time/view" class="btn btn-danger">Cancel</a>  
