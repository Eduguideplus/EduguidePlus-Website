<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/manage_philosophy/philosophy_view">Our Philosophy</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Our Philosophy(<?php echo count(@$philosophy);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_philosophy/philosophy_add" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add Our Philosophy </a></td>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               ?>
                ...
                <tr>
                  ...
                  <td> <a href="<?php echo base_url();?>index.php/manage_philosophy/philosophy_edit/<?php echo $row->id;?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
...
window.location=baseurl+'index.php/manage_philosophy/delete_philosophy/'+id;
}
}
   ...
   function change_sts_active(val)
        {
           ...
           // alert('ok');
             ...
             url:base_url+'index.php/manage_philosophy/change_to_active',
