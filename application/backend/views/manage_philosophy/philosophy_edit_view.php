      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_philosophy/philosophy_update" method="post" id="welcome_content_form" enctype="multipart/form-data">
              <div class="box-body">
              <div class="form-group">
                  <label for="company_name" class="col-sm-2 control-label"><center>Title<span style="color:#F00">*</span> </center></label>

                  <div class="col-sm-10">
                    <input type="text" name="title" id="title" class="form-control" value="<?php echo @$philosophy[0]->title; ?>"  >
            ...
            <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="content" class="tinyarea"   rows="5" cols="96" id="content"><?php echo @$philosophy[0]->content; ?></textarea>
              ...
              <input type="hidden" name="hidden_id" value="<?php echo @$philosophy[0]->id; ?>">
             
              <div id="error"></div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_philosophy/philosophy_view" class="btn btn-danger">Cancel</a>
