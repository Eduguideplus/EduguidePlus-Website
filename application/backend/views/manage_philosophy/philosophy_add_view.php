      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_philosophy/philosophy_insert" method="post" id="welcome_content_form" enctype="multipart/form-data">
              <div class="box-body">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="content" class="tinyarea"   rows="5" cols="96" id="content"></textarea>
              ...
              <div class="box-footer">
                ...
                <button type="button" onclick="return form_validation()" class="btn btn-info pull-right" >Insert</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
