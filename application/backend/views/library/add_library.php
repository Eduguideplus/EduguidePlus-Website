      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/Library/insert" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
                    ...
                    <option value="">Select</option>
                     <?php
                      ...
                      <div class="form-group" style="margin-top: 10px;">
                                    <label for="event_image" class="col-sm-2 control-label text-center">Upload file<span style="color:#F00">*</span></label>
                                    <div class="col-sm-7">
...
<div class="col-sm-9">
<input type="text"  name="file_infor" id="file_infor" class="form-control"  >
