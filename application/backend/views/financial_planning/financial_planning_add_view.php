            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form name="main" id="add" action="<?php echo base_url(); ?>index.php/manage_financial_planning/add_submit" role="form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                              ...
                              <div class="form-group" style="margin-top: 10px">
                                    ...
                                    <div class="col-sm-9">
                                         <div id="bottom_content"><textarea class="form-control tinyarea" name="content" id="content" rows="5"></textarea></div>
                                    </div>
                                ...
                                <div class="form-group" style="margin-top: 10px;">
                                    <label for="image" class="col-sm-2 control-label text-center">Image(600X400 px): <span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                                    <div class="col-sm-7">
