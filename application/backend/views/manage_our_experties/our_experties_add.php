      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_our_experties/insert" method="post" id="testiadd_form_validation" enctype="multipart/form-data" >
              <div class="box-body">

                  <div class="form-group" >
                    <label for="" class="col-sm-2 control-label">Expert Name<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="file" name="image" class="form-control"  id="image">
					       ...
					       <div class="form-group">
                  <label for="content" class="col-sm-2 control-label">About Expert<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
