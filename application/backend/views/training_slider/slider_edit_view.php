      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/training_slider/edit_slider" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <!--  <div class="form-group">
              ...
              <input type='hidden' name='id' value='<?php echo @$training[0]->id; ?>'>
               ...
               <div class="form-group"  id="image">
                        ...
                        <label for=" pro_image" class="col-sm-2 control-label"><center>Background Image(1700x700px):<span style="color:#F00">*</span></center> </label>
                        <div class="col-sm-10">
                        <input class="form-control" type="file" name="slider_photo" id="slider_photo" style="margin-bottom:12px">
                        <img style="height: 60px;width: 80px" src="<?php echo base_url(); ?>../assets/uploads/training_slider/<?php echo @$training[0]->slider_image; ?>">

                        <input class="form-control" type="hidden" name="hidden_slider" id="hidden_slider" value="<?php echo $training[0]->slider_image; ?>">
...
<!--  <div class="form-group" id="vid" >
              ...
              <div class="box-footer">
                <a href="<?php echo base_url()?>index.php/training_slider/view_training_slider" class="btn btn-danger">Cancel</a>
