<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/training_slider/view_training_slider"> Online Exam Background Image</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
            ...
            <table width="100%">
            <tr>
              <!-- <td width="50%"><a href="<?php echo base_url();?>index.php/training_slider/slider_add" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add Training Slider </a></td> -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               ?>
                ...
                if($row->slider_image!='')
                {
                  ?><img src="<?php echo base_url()."../assets/uploads/training_slider/".$row->slider_image;?>" style="height:80px;width:100px"></img> <?php
               }
             else
              {
            echo nl2br("No Image");
          ...
          ?> </td>
                  ...
                  <td> <a href="<?php echo base_url();?>index.php/training_slider/slider_edit/<?php echo $row->id;?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
...
window.location=baseurl+'index.php/training_slider/delete_slider/'+id;
}
}
   ...
   function change_sts_active(val)
        {
           ...
           // alert('ok');
             ...
             url:base_url+'index.php/training_slider/change_to_active',
