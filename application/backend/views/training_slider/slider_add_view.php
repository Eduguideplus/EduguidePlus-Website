      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/training_slider/slider_insert" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <!--  <div class="form-group">
              ...
              <div class="form-group" id="fl">
                  <label for="class" class="col-sm-2 control-label">Training Slider Photo(1700x700px)<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
...
<script>
  function validation()
  {
      ...
      var slider_photo = $('#slider_photo').val();
      if (!isNull(slider_photo)) {
        $('#slider_photo').removeClass('black_border').addClass('red_border');
      } else {
        $('#slider_photo').removeClass('red_border').addClass('black_border');
      }
  }
