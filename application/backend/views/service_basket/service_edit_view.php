      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_service_basket/edit_service_basket" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <input type='hidden' name='id' value='<?php echo @$service[0]->id; ?>'>
               ...
               <div class="form-group"  id="image">
                        ...
                        <label for=" pro_image" class="col-sm-2 control-label"><center>Service Icon(405x193px):<span style="color:#F00">*</span></center> </label>
                        <div class="col-sm-10">
                        <input class="form-control" type="file" name="service_icon" id="service_icon" style="margin-bottom:12px">
                        <img style="height: 60px;width: 80px" src="<?php echo base_url(); ?>../assets/uploads/service_basket/<?php echo @$service[0]->service_icon; ?>">

                        <input class="form-control" type="hidden" name="hidden_service_icon" id="hidden_service_icon" value="<?php echo $service[0]->service_icon; ?>">
