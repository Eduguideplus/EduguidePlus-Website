  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
       ...
       Edit Abroad Fees Details
      </h3>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Edit Abroad Fees Details</li>    
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
         ...
         <div style="padding-left: 12px;"><?php echo $this->session->flashdata('msg'); ?></div>
            ...
            <form id="add" name="form" class="form-horizontal" action="<?php echo base_url();?>index.php/manage_study_abroad_fees/edit_tender_submit/<?php echo $this->uri->segment(3); ?>" method="post" enctype='multipart/form-data'>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">Course Name :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                    <div class="col-sm-9" >
                      
                      
                       <textarea class="form-control" required="" name="course_name" id="course_name" placeholder="" ><?php echo @$tender[0]->course_name; ?></textarea>
                      
                    </div>
                 
                </div>
                <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">College Name :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                    <div class="col-sm-9" >
                      
                      
                       <textarea class="form-control" required="" name="college_name" id="college_name" placeholder="" ><?php echo @$tender[0]->college_name; ?></textarea>
                 ...
                 <div class="form-group">
                  <label for="branch_address" class="col-sm-2 control-label">Fees :<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>

                    <div class="col-sm-9" >
                      
                      
                       <textarea class="form-control" name="fees" id="fees" placeholder="" required="" ><?php echo @$tender[0]->fees; ?></textarea>
                      
                    </div>
                 
                </div>

                <input type="hidden" name="study_abroad_id" id="study_abroad_id" value="<?php echo $this->uri->segment(4); ?>">


                <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$tender[0]->abroad_fee_id; ?>">

                  <!-- <input type="hidden" name="study_abroad_id" id="study_abroad_id" value="<?php echo $this->uri->segment(3); ?>"> -->
             ...
             <span style="color: rgb(255, 0, 0); padding-left: 2px;">* fields are required</span>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_study_abroad_fees/list_view/<?php echo $this->uri->segment(4); ?>" class="btn btn-danger fa fa-backward"><b>  Back</b></a>
