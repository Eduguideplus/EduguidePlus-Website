            ...
            if($succ_update){
              ...
              ?></small>
                    ...
                    <div class="col-md-12" style="">
                        ...
                        <a href="<?php echo base_url()?>index.php/manage_study_abroad_fees/add_view/<?php echo $this->uri->segment(3); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
          ...
          <a href="javascript:void(0)" class="btn btn-danger btn-action" title="Inactive" onclick="change_sts_active('inactive')"><i class="fa fa-pencil-square-o" ></i> Inactive</a>
            ...
            <div class="clearfix"></div>        
                ...
                <td>
                       ...
                       <a href="<?php echo base_url()?>index.php/manage_study_abroad_fees/edit_tender/<?php echo $row->abroad_fee_id; ?>/<?php echo $this->uri->segment(3); ?> " class="btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

                      
                          <button type="button" class="btn-btn btn-danger" onclick="return delete_data(<?php echo $row->abroad_fee_id;?>)" title="Delete"><i class="fa fa-trash-o"></i> Delete</button>
 ...
 <script type="text/javascript">
         ...
         function change_sts_active(val)
        {
            ...
            $.ajax({
             ...
             url:base_url+'index.php/manage_study_abroad_fees/change_to_active',
   ...
   <script type="text/javascript">
          function delete_data(id)
          {
            ...
            {
                window.location.href="<?php echo base_url();?>index.php/manage_study_abroad_fees/delete_tender/"+id+'/'+<?php echo $this->uri->segment(3); ?>;
            }
          }
...
$.ajax({
              ...
              url:base_url+'index.php/manage_study_abroad_fees/change_home_status',
              data:{cid:id},
              dataType: "json",
              type: "POST",
              success: function(data){
