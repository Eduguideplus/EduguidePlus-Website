<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       MANAGE KNOWLEDGE,KNOC,QUIZ TEST-PLANS 
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/manage_category/category_view">Plans</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Plans(<?php echo count($plans);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_plans/add" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add </a></td>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               ?>
                ...
                <?php 
                $plan_id = $row->id;
                $plan_details = $this->admin_model->selectone('tbl_plan_details','plan_id',$plan_id);
                ?>
                <td>
