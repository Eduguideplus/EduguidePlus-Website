      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_plans/general_update" method="post" id="add" >
              <div class="box-body">
             ...
             <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="plan_price12" id="plan_price12" class="form-control" placeholder="" value="<?php echo @$view[0]->plan_price; ?>">
             ...
             <input type="hidden" name="general_edit_id" id="general_edit_id" value="<?php echo @$ids;?>" >
