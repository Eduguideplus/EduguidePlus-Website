      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/About_exam/insert" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="exam_name" id="exam_name" class="form-control" placeholder="" value="" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="eligibility" id="eligibility" class="form-control" placeholder="" value="" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="vacancy" id="vacancy" class="form-control" placeholder="" value="" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea type="text" name="selec_process" id="selec_process" class="form-control " ></textarea>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea type="text" name="hw_to_apply" id="hw_to_apply" class="form-control " ></textarea>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="date" name="appl_start_date" id="appl_start_date" class="form-control" placeholder="" value="">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="date" name="appl_closing_date" id="appl_closing_date" class="form-control" placeholder="" value="">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="preparation" id="preparation" class="form-control" placeholder="" value="">
