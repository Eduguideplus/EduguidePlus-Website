      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_institution/insert_inst_info" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <textarea name="info_1" id="info_1" class="form-control" placeholder="Institute Information"></textarea>
                    
                  </div>
                 
              </div>

              <input type="hidden" name="inst_id" id="inst_id" value="<?php echo $ins_id; ?>">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <textarea name="info_2" id="info_2" class="form-control" placeholder="Institute Information"></textarea>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <textarea name="info_3" id="info_3" class="form-control" placeholder="Institute Information"></textarea>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_institution/inst_info/<?php echo $this->uri->segment(3); ?>" class="btn btn-danger">Cancel</a>
