      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_exam_type/insert_single_video" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <!--  <div class="form-group">
              ...
              <input type="hidden" name="exam_info_id" id="exam_info_id" value="<?php echo $exam_info_id; ?>">
            ...
            <!--   <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="video" id="video" class="form-control" placeholder="Youtube video Embed Link">
...
<!-- 
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_exam_type/info_video/<?php echo $this->uri->segment(3); ?>/<?php echo $exam_info_id; ?>" class="btn btn-danger">Cancel</a>
