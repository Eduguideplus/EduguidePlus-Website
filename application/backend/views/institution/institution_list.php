<div class="content-wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <td class="search_button">
            	<input class="search_text" type="text" name="search_ins" id="search_ins" placeholder="Search By Institute Name"  >
            	<input class="search_btn_cl" type="button" name="search_btn" value="Search" onclick="search_by_institute();" > 
            </td>
 ...
 <?php } ?>
     ...
     <div id="pagination_id"> <?php echo @$links; ?> </div>
    </section>
    </div>
    </div>
    <script>
...
function check_all()
{
  ...
  function search_by_institute()
  {
    ...
    var search_name=  $('#search_ins').val();
    

       $.ajax({
              
             url:base_url+'index.php/manage_institution/search_by_institute',
