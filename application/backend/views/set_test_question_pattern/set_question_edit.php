      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_set_test_question_pattern/update" method="post" id="add_know" >
              <div class="box-body">
               <span style="color: rgb(255, 0, 0); padding-left: 2px;">(* fields are required)</span>
                 ...
                 <!-- <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select name="group_name" id="group_name" class="form-control" onchange="get_exam_name(value)">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select name="test" id="test" disabled="" onchange="get_test(this.value)" class="form-control">
                      <option value="">---Select Test---</option>
                      <?php
                      foreach($test_type as $row)
                      {
                        ?>
                        <option value="<?php echo $row->test_name;?>"<?php if($set_pattern_details[0]->test_type==$row->test_name){ echo "selected"; } ?>><?php echo $row->test_name;?></option>
                        <?php
                        }
                        ?>
               ...
               <div id="mock_test_id" style="display:<?php if($set_pattern_details[0]->test_type=='Mock Test'){ ?> block<?php } else{?> none;<?php } ?>">
                 <div class="form-group" >
                  ...
                  <div class="col-sm-4">
                    ...
                    <select class="form-control" disabled="" name="test_type" id="test_type">
                      <option value="">Select Test Type</option>
                      <?php 
                      foreach($exam_test_type as $test)
                      {
                        ?>
                        <option value="<?php echo $test->test_name;?>"<?php if($test->test_name==$set_pattern_details[0]->test_select_name){ echo "selected"; }?>><?php echo $test->test_name;?></option>
                        <?php
                      }
                      ?>
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $set_pattern_details[0]->no_of_question ?>" name="no_of_question" id="no_of_question" class="form-control" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"oncopy="return false" ondrag="return false" ondrop="return false" onpaste="return false">
              ...
              <div class="form-group" >
                  ...
                  <div class="col-sm-4">
                    ...
                    <input  class="form-control" value="<?php echo $set_pattern_details[0]->no_of_marks ?>" type="text" id="marks_of_question" onblur="calculate_marks(value)"  name="marks_of_question" maxlength="10" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"oncopy="return false" ondrag="return false" ondrop="return false" onpaste="return false">
              ...
              <div class="form-group" id="chap_section">
                <label for="class" class="col-sm-2 control-label">Total Marks <span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $set_pattern_details[0]->total_marks ?>" name="total_marks" id="total_marks" class="form-control" readonly>
              ...
              <div class="form-group" >
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $set_pattern_details[0]->time_question_second ?>" name="tim_marks" id="tim_marks" class="form-control" onblur="calculate_duration(value)">
              ...
              <div class="form-group" id="chap_section">
                <label for="class" class="col-sm-2 control-label">Total Time<span style="color: rgb(255, 0, 0); padding-left: 2px;">*</span></label>
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $set_pattern_details[0]->total_time ?>" name="total_time" id="total_time" class="form-control" readonly>

                    <input type="hidden" name="pattern_id" value="<?php echo $set_pattern_details[0]->pattern_id ?>">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-info pull-right" onclick="return know_form_validation()">Update Set</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
