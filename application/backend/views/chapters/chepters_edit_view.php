          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_chapters/update" method="post" id="edit" enctype="multipart/form-data">
             ...
             <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select name="sub_name" id="sub_name" class="form-control">
                      ...
                      <?php foreach($subjects as $sub){?>
                       <option value="<?php echo $sub->sub_id; ?>" <?php if($chapters[0]->sub_id==$sub->sub_id){echo 'selected';}?>><?php echo $sub->sub_name; ?></option>
                       <?php } ?>
                    </select>
              ...
              <input type="hidden" value="<?php echo @$subjects[0]->chap_id;?>" name="edit_id" >
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_subjects/view" class="btn btn-danger">Cancel</a>
