<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>index.php/manage_why_us/why_us_view">Why Us</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All About Us(<?php echo count(@$whyus);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <!-- <td width="50%"><a href="<?php echo base_url();?>index.php/manage_why_us/whyus_add" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add Why Us </a></td> -->
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               ?>
                ...
                <tr>
                  ...
                  <td><?php if($row->image!=''){?>
                  <img src="<?php echo base_url();?>../assets/uploads/whyus/<?php echo $row->image;?>" height="30px" width="30px"> <?php } else { echo 'No Image'; }?> </td>

              
                  
                  
                  <td> <a href="<?php echo base_url();?>index.php/manage_why_us/whyus_edit/<?php echo $row->id;?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
...
window.location=baseurl+'index.php/manage_why_us/delete_whyus/'+id;
}
}
   ...
   function change_sts_active(val)
        {
           ...
           // alert('ok');
             ...
             url:base_url+'index.php/manage_why_us/change_to_active',
