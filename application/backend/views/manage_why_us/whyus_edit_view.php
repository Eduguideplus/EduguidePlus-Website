      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_why_us/whyus_update" method="post" id="welcome_content_form" enctype="multipart/form-data">
              <div class="box-body">
              <div class="form-group">
                  <label for="company_name" class="col-sm-2 control-label"><center>Title<span style="color:#F00">*</span> </center></label>

                  <div class="col-sm-10">
                    <input type="text" name="title" id="title" class="form-control" value="<?php echo @$whyus[0]->title; ?>"  >
            ...
            <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea name="content" class="tinyarea"   rows="5" cols="96" id="content"><?php echo @$whyus[0]->content; ?></textarea>
                ...
                <div class="form-group">
                  <label for="mobile" class="col-sm-2 control-label"><center>Image<span style="color:#F00">*</span> </center></label>

                  <div class="col-sm-10" >
                   
                   <input type="file" name="cat_icon" id="cat_icon" class="form-control" placeholder="" value="">
                    <input type="hidden" name="old_image" id="old_image" value="<?php echo @$whyus[0]->image;?>" >

                    <img src="<?php echo base_url();?>../assets/uploads/whyus/<?php echo @$whyus[0]->image;?>" width="50px" height="50px">
              ...
              <input type="hidden" name="hidden_id" value="<?php echo @$whyus[0]->id; ?>">
             
              <div id="error"></div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_why_us/why_us_view" class="btn btn-danger">Cancel</a>
