      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_why_us/whyus_insert" method="post" id="welcome_content_form" enctype="multipart/form-data">
              <div class="box-body">
