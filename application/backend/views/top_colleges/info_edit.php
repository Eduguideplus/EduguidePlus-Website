      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_institution/update_inst_info" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
                  <label for="cat_name" class="col-sm-2 control-label">Information 1<span style="color: rgb(255, 0, 0); padding-left: 2px;"></span></label>

                  <div class="col-sm-9">
                    

                    <textarea name="info_1" id="info_1" class="form-control" placeholder="Institute Information"><?php echo @$inst_info[0]->info_content_1; ?></textarea>
             ...
             <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$inst_info[0]->id; ?>">

                 <div class="form-group">
                  <label for="cat_name" class="col-sm-2 control-label">Information 2<span style="color: rgb(255, 0, 0); padding-left: 2px;"></span></label>

                  <div class="col-sm-9">
                    

                    <textarea name="info_2" id="info_2" class="form-control" placeholder="Institute Information"><?php echo @$inst_info[0]->info_content_2; ?></textarea>
                 ...
                 <div class="form-group">
                  <label for="cat_name" class="col-sm-2 control-label">Information 3<span style="color: rgb(255, 0, 0); padding-left: 2px;"></span></label>

                  <div class="col-sm-9">
                    

                    <textarea name="info_3" id="info_3" class="form-control" placeholder="Institute Information"><?php echo @$inst_info[0]->info_content_3; ?></textarea>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_institution/inst_info/<?php echo $this->uri->segment(4); ?>" class="btn btn-danger">Cancel</a>
