      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_exam_type/update_video_title" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$video_title[0]->exam_info_id; ?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="video_title" id="video_title" class="form-control" placeholder="Information Title" value="<?php echo @$video_title[0]->video_title; ?>" >
            ...
            <!--   <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="video" id="video" class="form-control" placeholder="Description Title" value="<?php echo @$video_info[0]->video; ?>">
...
<!-- 
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_exam_type/info_video/<?php echo $this->uri->segment(3); ?>/<?php echo @$video_title[0]->exam_info_id; ?>" class="btn btn-danger">Cancel</a>
