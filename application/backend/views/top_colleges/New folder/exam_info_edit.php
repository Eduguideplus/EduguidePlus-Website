      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_exam_type/update_exam_info" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$exam_info[0]->info_id; ?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="info_title" id="info_title" class="form-control" placeholder="Information Title" value="<?php echo @$exam_info[0]->info_title; ?>" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="des_title" id="des_title" class="form-control" placeholder="Description Title" value="<?php echo @$exam_info[0]->info_description_title  ; ?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="Description"><?php echo @$exam_info[0]->info_description ; ?></textarea>
