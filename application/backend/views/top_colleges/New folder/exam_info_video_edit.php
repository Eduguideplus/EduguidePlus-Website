<script language="JavaScript" type="text/javascript" src="<?php echo base_url();?>tiny_mce/tiny_mce.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        EXAMINATION INFORMATION VIDEO EDIT
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_exam_type/update_video" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <input type="hidden" name="edit_id" id="edit_id" value="<?php echo @$video_info[0]->video_id; ?>">
             <input type="hidden" name="exam_info_id" id="exam_info_id" value="<?php echo @$video_info[0]->exam_info_id; ?>">
            ...
            <!--   <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="video_title" id="video_title" class="form-control" placeholder="Information Title" value="<?php echo @$video_info[0]->video_title; ?>" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="video" id="video" class="form-control" placeholder="Youtube video Embed Link" value="<?php echo @$video_info[0]->video; ?>">

                    <iframe width="140" height="125"
                              src="<?php echo @$video_info[0]->video; ?>">
                           </iframe> 
           ...
           <!-- <?php 
                   $video=$this->common_model->common($table_name = 'tbl_exam_info_video', $field = array(), $where = array('exam_info_id'=>@$exam_info[0]->info_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
            ...
            ?> -->
             ...
             <!--  <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="video_title" id="video_title" class="form-control" placeholder="Video Title" value="<?php echo @$video[0]->video_title; ?>">
...
<!-- 
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_exam_type/info_video/<?php echo $this->uri->segment(3); ?>/<?php echo @$video_info[0]->exam_info_id; ?>" class="btn btn-danger">Cancel</a>
