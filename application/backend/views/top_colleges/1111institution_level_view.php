        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Institution Level(<?php echo count($inst_level);?>)</h3>
            </div>
            <!-- /.box-header -->
            
            <table width="100%">
            <tr>
              <td width="50%"><a href="<?php echo base_url();?>index.php/manage_exam_type/add_course" class="btn btn-primary btn-action" title="Add"><i class="fa fa-pencil-square-o"></i> Add </a></td>
               ...
               ?>
                ...
                <tr>
                 ...
                 <td><?php echo @$row->id;?></td>
                  ...
                  <td> <a href="<?php echo base_url();?>index.php/manage_exam_type/course_edit/<?php echo $row->id;?>" class="btn btn-info btn-action" title="View & Edit"><i class="fa fa-pencil-square-o"></i></a>
...
window.location=baseurl+'index.php/manage_exam_type/course_delete/'+id;
}
}
