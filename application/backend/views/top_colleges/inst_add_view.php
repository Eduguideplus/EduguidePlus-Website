      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_top_college/insert_top_college" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
           ...
           <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="header" id="header" class="form-control">
                       ...
                       <option value="<?php echo $data->header_id; ?>"><?php echo $data->header; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="college" id="college" class="form-control">
                       ...
                       <option value="<?php echo $data->id; ?>"><?php echo $data->institute_name; ?></option>
