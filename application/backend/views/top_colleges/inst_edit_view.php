      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url();?>index.php/manage_top_college/update_top_college" method="post" id="add" enctype="multipart/form-data">
              <div class="box-body">
           ...
           <div class="form-group">
                  <label for="sub_category" class="col-sm-2 control-label">Header</label>
              
                <div class="col-sm-9">
                    <select name="header" id="header" class="form-control">
                        <option value="">Select Top College Header</option>
                        <?php foreach ($header as $data) { ?>
                          
                       <option value="<?php echo $data->header_id; ?>"<?php if($data->header_id==@$top[0]->header_id) { echo 'selected'; } ?>><?php echo $data->header; ?></option>
              ...
              <div class="form-group">
                  <label for="sub_category" class="col-sm-2 control-label">College</label>
              
                <div class="col-sm-9">
                    <select name="college" id="college" class="form-control">
                        <option value="">Select College</option>
                        <?php foreach ($inst as $data) { ?>
                          
                       <option value="<?php echo $data->id; ?>"<?php if($data->id==@$top[0]->college_id) { echo 'selected'; } ?>><?php echo $data->institute_name; ?></option>
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="type" id="type" class="form-control" placeholder="Type" value="<?php echo @$top[0]->type ?>" readonly>
                    
                  </div>
                 
              </div>
   
   <input type="hidden" name="edit_id" id="edit_id" class="form-control" placeholder="Type" value="<?php echo @$top[0]->top_college_id ?>" readonly>

                   <div class="form-group">
                  <label for="sub_category" class="col-sm-2 control-label">Course</label>
                ...
                <div class="col-sm-9">
                    <select name="course" id="course" class="form-control">
                       ...
                       <option value="<?php echo $data->id; ?>"<?php if($data->id==@$top[0]->course) { echo 'selected'; } ?>><?php echo $data->exam_name; ?></option>
               ...
               <div class="form-group">
                  <label for="cat_name" class="col-sm-2 control-label">Duration<span style="color: rgb(255, 0, 0); padding-left: 2px;"></span></label>

                  <div class="col-sm-9">
                    <input type="text" name="duration" id="duration" class="form-control" placeholder="Course Duration" value="<?php echo @$top[0]->duration ?>">
...
<!-- 
              ...
              <div class="box-footer">
                <a href="<?php echo base_url();?>index.php/manage_top_college/inst_list" class="btn btn-danger">Cancel</a>
...
<script>
  ...
  $(document).ready(function(){
    $('#college').change(function(){
      ...
      if(college_id=="")
      {
        alert("Plase Select College");
      }
      
    if(college_id != '')
    {
       $.ajax({
         url:"<?php echo base_url();?>index.php/manage_top_college/fetch_college_type",
         method:"POST",
         dataType:"json",
         ...
         success:function(data)
         {
          ...
          /*for(i=0;i<clg_type.length;i++)
          {

           data_html=clg_type[i].management_of_inst;
          }*/
