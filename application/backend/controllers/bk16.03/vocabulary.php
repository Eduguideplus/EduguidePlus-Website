...
public function vocabulary_view()
{
	...
	$data['vocabulary']=$this->admin_model->selectAll('tbl_english_vocabulary');

	$this->load->view('template/admin_header');
    $this->load->view('template/admin_leftmenu');
	$this->load->view('vocabulary/vocabulary_table_view',$data);
...
function add()
{
    ...
    $this->load->view('template/admin_header');
    $this->load->view('template/admin_leftmenu');
    $this->load->view('vocabulary/vocabulary_view');
    $this->load->view('template/adminfooter_category');
}
 
   
function vocabulary_insert()
{
    ...
    $vocabulary=$this->admin_model->selectAll('tbl_english_vocabulary');
		...
		$this->db->insert('tbl_english_vocabulary',$data);
