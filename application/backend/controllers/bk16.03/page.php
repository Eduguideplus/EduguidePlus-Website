...
{ 
	 ...
	 function add_page_action()
	 {
		...
		$this->session->set_flashdata('page_content',$page_content);
		 ...
		 else
		 {
			 ...
			 redirect('index.php/page/add_page','refresh');
		 }
	 }
	 ...
	 function page_edit()
	 {
			...
			if($id)
			{
				...
				{
					$this->load->view('template/admin_header',$data_user);
					$this->load->view('template/admin_leftmenu');
	 ...
	 function page_edit_action()
	 {
		  ...
		  { 
		   ...
		   $image_config["source_image"] ='../assets/uploads/'.$image;   //$upload_data["full_path"];
		   $image_config['create_thumb'] = FALSE;
		   $image_config['maintain_ratio'] =FALSE;
		   $image_config['new_image'] = '../assets/uploads/'.$image; //$upload_data["file_path"] . 'product.png';
		...
		{
			@unlink('../assets/uploads/'.$hidden_img);
		}
