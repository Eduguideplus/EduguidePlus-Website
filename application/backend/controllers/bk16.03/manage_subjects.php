...
public function view()
{
	...
	$data['subjects']=$this->admin_model->selectAll('tbl_test_type');
...
//print_r($data['type']);exit;
    $this->load->view('template/admin_header');
		$this->load->view('template/admin_leftmenu');
		$this->load->view('subjects/test_type_add_view');
		$this->load->view('template/adminfooter_category');
    }
    ...
    function insert()
    {
      ...
      $current_date=date('Y-m-d H:i:s');
    	...
    	redirect('index.php/manage_subjects/view/','refresh');
...

{
    ...
    $data['subjects']=$this->admin_model->selectone('tbl_test_type','test_id',$sub_id);

    $this->load->view('template/admin_header');
    $this->load->view('template/admin_leftmenu');
    $this->load->view('subjects/test_type_edit_view',$data);
    $this->load->view('template/adminfooter_category');
}
function update()
{
