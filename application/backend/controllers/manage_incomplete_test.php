...
class manage_incomplete_test extends CI_Controller {
...
public function __construct()
{
	...
	{
		$data['incomplete_test']=$this->set_model->get_completed_exam_except_practice_incomplete();
		//print_r($data['incomplete_test']);exit;
		
		$this->load->view('template/admin_header');
    	$this->load->view('template/admin_leftmenu');
		$this->load->view('manage_incomplete_tests/all_incomplete_test_view',$data);	
