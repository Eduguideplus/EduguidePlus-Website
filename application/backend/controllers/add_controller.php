...
{ 
	...
	{	
        ...
        $data['admin_details'] = $this->session_check_and_session_data->admin_session_data();
 		...
 		if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('add_controller',get_cookie('session_user_id'))=='Y' || $admin_details[0]->user_type_id==1)
		{
	 ...
	 { 
        ...
        $data['admin_details'] = $this->session_check_and_session_data->admin_session_data();
 		...
 		if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('add_controller/add_new_controller',get_cookie('session_user_id'))=='Y' || $admin_details[0]->user_type_id==1)
		{ 
	 ...
	 function add_controller_action()
	 {
		...
		if($management!="" && $title!="" && $controller!="")
		{
			...
			$this->db->insert('tbl_admin_parent_page',$data);
			 ...
			 redirect('index.php/add_controller','refresh');
		}
		else
		{
	 ...
	 function controller_edit($id)
	 {
        ...
        $data['admin_details'] = $this->session_check_and_session_data->admin_session_data();
 		...
 		if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('add_controller/controller_edit',get_cookie('session_user_id'))=='Y' || $admin_details[0]->user_type_id==1)
		{
		$data['management_list']=$this->admin_model->selectAll('tbl_admin_management');
	 ...
	 function controller_delete($id)
	 {
        ...
        $data['admin_details'] = $this->session_check_and_session_data->admin_session_data();
 		...
 		if(@$this->user_page_permission_checki_availablity_view_model->check_permission_for_controller('add_controller/controller_delete',get_cookie('session_user_id'))=='Y' || $admin_details[0]->user_type_id==1)
		{ 
