...
function check_available_question()
{
    ...
    if(count($check_test_availablity)==0)
    {
           ...
           set_cookie('set_name',$actual_name,'3600');
           set_cookie('set_slug',$set_slug,'3600');
           set_cookie('test_type',$test_type,'3600');
           set_cookie('group_id',$group_name,'3600');
           set_cookie('exam_id',$exam_name,'3600');
           set_cookie('subject_id',$sub_name,'3600');
           set_cookie('exam_instruction',$instruction,'3600');
           set_cookie('set_code',$exam_code,'3600');
           set_cookie('created_on',$current_date,'3600');
           set_cookie('created_by',$user_id,'3600');
...
$data['question_list']= $data_qs;
 ...
 $this->load->view('template/admin_header');
    ...
    function manual_test_create_submit()
    {
        ...
        $test_type=get_cookie('test_type');
        $group_name=get_cookie('group_id');
        $exam_name=get_cookie('exam_id');
        $sub_name=get_cookie('subject_id');
        ...
        $exam_duration=0;
        $exam_fees=0;
        $instruction=get_cookie('exam_instruction');

      /*  $test_name=$this->session->userdata('set_name');*/
        $test_name=get_cookie('set_name');
        // echo $instruction; exit; 
        $current_date=date('Y-m-d H:i:s');
