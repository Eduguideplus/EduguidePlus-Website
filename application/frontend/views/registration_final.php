    ...
    <div class="col-md-8 col-md-offset-2 text-center log-in">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="log-section">
          <h6 class="text-center" style="color:#4efd4e;"><strong><?php if($this->session->flashdata('succ_msg')!=''){echo $this->session->flashdata('succ_msg'); }?></strong></h6>
				  ...
				  <div class="tab-content">
				    <div id="home" class="tab-pane fade in active">
				    		<h5>Other Details</h5>
					          ...
					          <form method="post" action="<?php echo @$this->url->link(111);?>" class="login-form creat-form" id="std_form">
                      ...
                      <?php foreach($countries as $cnt){?>
                        ...
                        <select  class="form-control" placeholder="Languages Known" name="languages" id="languages" onchange="make_effect()">
                        ...
                        <input type="text"  class="form-control" placeholder="Other Language" name="other_language" id="other_language" >
					              ...
					              <input type="hidden" name="hid_user" id="hid_user" value="<?php echo @$user_dtls[0]->id; ?>">
					               ...
					               <div class="form-group">
					                <button value="" type="button" class="btn read-btn" onclick="final_validation_submit()">SUBMIT</button>
...
<script src="<?php echo base_url();?>custom_script/validation_rulse.js"></script>
 ...
 <script>
    ...
    /*var st_name = $('#st_name').val();
      ...
      if (!isNull(languages)) {
        ...
        if(languages=='Others')
        {
          ...
          if(!isNull(other_language))
          {
             $('#other_language').removeClass('black_border').addClass('red_border');
          }
          else
          {
             $('#other_language').removeClass('red_border').addClass('black_border');
          }
        }
  ...
  function final_validation_submit()
  {
