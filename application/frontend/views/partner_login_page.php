...
<div class="container-fluid login_register deximJobs_tabs practice " style="background-image: url(<?php echo base_url(); ?>assets/images/partner_login_back.jpg);">
    ...
    <div class="col-md-10 col-md-offset-1 text-center log-in">
      ...
      <div class="col-md-6 col-sm-8 col-xs-12 col-md-offset-3">
        ...
        <div class="log-section">
          ...
          <form method="post" action="<?php echo base_url();?>Partner_login/login_action" class="login-form" id="manual_login">
            ...
            <?php } ?>
              ...
              <input type="text" class="form-control" placeholder="" name="email1" id="email1" onblur="check_email(this.value)" required>
...

          {
            ...
            $.ajax(

                {
                    ...
                    url:"<?php echo base_url();?>index.php/Partner_login/check_email_exist",
