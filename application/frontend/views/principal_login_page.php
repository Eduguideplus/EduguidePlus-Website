    ...
    <div class="col-md-10 col-md-offset-1 text-center log-in">
      ...
      <div class="col-md-6 col-sm-8 col-xs-12 col-md-offset-3">
        <div class="log-section">
          ...
          <form method="post" action="<?php echo base_url();?>Principal_login/login_action" class="login-form" id="manual_login">
            ...
            $.ajax(
                {
                    type: "POST",
                    dataType:'json',
                    url:"<?php echo base_url();?>index.php/Principal_login/check_email_exist",
