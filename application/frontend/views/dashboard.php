  	...
  	<?php } ?>
         ...
         <div class="myaccount-field myaccount-widget">
          ...
          <div class="welcome_deshboard">
            ...
            <!-- <a href="https://www.nism.surajitpramanick.com/" class="pull-right">Go For Test</a> -->
            <div class="btn-cus-option">
            <a href="<?php echo base_url(); ?>shedule_to_meet">Schedule To Meet</a>
            <a href="<?php echo $this->url->link(131); ?>">Go For Test</a>
          ...
          <?php } ?>
            ...
            <a href="<?php echo $this->url->link(98);?>">My Profile</a>
          ...
          <div class="dashboard_button text-right">
            ...
            <button class="pdf" onclick="download_pdf('<?php echo $user[0]->id; ?>');" >PDF</button>
            <!-- <button class="pdf">JPG</button> -->
            <button class="excel" onclick="download_csv('<?php echo $user[0]->id; ?>');">EXCEL</button>
          </div>
        ...
        <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo @$get_examdetail[0]->exam_name.': '.$setname; ?></td>
              <td><?php echo @$get_subdetail[0]->section_name ; ?></td>
              <td><?php echo round($res->q_qty); ?></td>
             <!--  <td><?php echo gmdate('H:i:s',$res->exam_duration ); ?></td> -->
              <td><?php echo round($res->attempt_count); ?></td>
              
             <!--  <td><?php echo $res->curr_ans; ?></td> -->
          ...
          ?>
          <tr>
              <td colspan="11">You didn't appear any Test yet</td>
...
<script type="text/javascript">
  ...
  {
    //  alert(student_id);
      window.location='<?php echo base_url();?>Dashboard/download_student_details_pdf/'+student_id;
  }
</script>
