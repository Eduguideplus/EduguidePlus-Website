...
<div class="ed_dashboard_wrapper">
    ...
    <div class="container">
        ...
        $suc_msg=$this->session->flashdata('success_msg');
        ...
        ?>
                ...
                <div class="alert alert-success alert-dismissable">
                  ...
                  <strong>Thank You!</strong> <?php echo @$suc_msg; ?>
        ...
        $mobile_msg=$this->session->flashdata('mob_msg');
        ...
        ?>
                ...
                <div class="alert alert-success alert-dismissable">
                  ...
                  <strong>Thank You!</strong> <?php echo @$mobile_msg; ?>
        ...
        <?php } ?>    
            ...
            <div class="ed_dashboard_tab">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="dashboard">
                        ...
                        <div class="ed_dashboard_tab_info" id="scroll_to_here">
                        ...
                        <p class="wellcome-p">Hi <strong><?php echo $user[0]->first_name;?></strong>, here you have to see and update your profile, subscribed courses, activities, notifications and other things. All the above updates can be modified from the right panel provided.</p>
          ...
          <div class="col-md-12" id="cart_success" style="display:none">

         <div class="alert alert-success" >

          <strong>Success!</strong> You plan have successfully added to cart.

        </div>

      </div> 

      <div class="priceing_tables mt-50">
    ...
    <?php foreach ($general as $gen) {
      ...
      $dis=$gen->plan_price*($gen->no_of_company*10)/100;

    $dis_price=$gen->plan_price-$dis;

         ?>

   <div class="col-md-4 col-md-offset-2 col-xs-12 col-sm-6 text-center no-padd wid-40 margin">
      ...
      <div class="mt-card subscription-pack ng-scope subs-inactive text-left"> 
        ...
        <div class="mar-h-auto text-center price-details">
          ...
          <div class="font-weight-semibold font-size-medium-1 text-white tb-gradient-1 price-details-top">
            ...
            <div class="visible-subs-inactive visible-subs-expired ng-binding">Save <i class="fa fa-inr"></i><?php echo number_format($dis,2); ?></div>
          ...
          <div class="price-details-bottom">
            ...
            <div class="line-height-1 d-inline-block align-middle">
              ...
              <div class="text-line-through font-size-base-1 text-gray-8 mar-b4 visible-subs-inactive visible-subs-expired ng-binding line-over">
                ...
                <i class="fa fa-inr"></i><?php echo $gen->plan_price; ?>

              </div>

              <div class="text-gray-5 font-size-large font-weight-bold mar-b4">

                <div class="visible-subs-inactive visible-subs-expired"><i class="fa fa-inr"></i><span class="pack-selling-price ng-binding"><?php echo number_format($dis_price,2); ?></span></div>

                <div class="visible-subs-active ng-binding"><?php echo $gen->plan_month_duration; ?> Month</div>

              </div>

              <div class="text-gray-8 font-size-small hidden-subs-active ng-binding">For <?php echo $gen->plan_month_duration; ?> Month</div>
        ...
        <h3 class="mar-t24 pack-title ng-binding"><?php echo $gen->plan_title; ?></h3>

        <div class="subs-state">

          <p class="font-weight-bold visible-subs-inactive ng-binding"><?php echo $gen->plan_month_duration; ?> Month Subscription</p>

          <p class="font-weight-bold text-success visible-subs-active ng-binding"><?php echo $gen->plan_month_duration; ?> Month Subscription is Active</p>

          <!-- release btn -->

          <a href="<?php echo $this->url->link(77);?>" class="release" target="blank">Release Plan</a>
        ...
        <div class="pack-status">
          ...
          <p class="mar-b0 font-size-base-1 font-weight-semibold visible-subs-inactive visible-subs-expired ng-binding"><?php echo $gen->paper_per_company;?> Test Each</p>
        ...
        <hr class="mar-v8 visible-subs-inactive visible-subs-expired">
         ...
         <span class="pull-left">Select Company (Max:<?php echo $gen->no_of_company;?>) :<p id="s_c_<?php echo $gen->id;?>" style="color:red"></p></span><select class="form-control select2" multiple="multiple" placeholder="Select Company" id="select_company_<?php echo $gen->id;?>" required>
              ...
              <?php foreach ($company as $com) {
               ...
               <option value="<?php echo $com->id;?>"><?php echo $com->exam_name;?></option>

               <?php } ?></select>

                <input type="hidden" id="total_company_<?php echo $gen->id;?>" name="" value="<?php echo $gen->no_of_company;?>">
        ...
        <div class="buy-now-btn">
          ...
          <button type="button" class="btn btn-block upgrade-btn"  onclick="select_company(<?php echo $gen->id;?>)">
...
<?php } ?>
   ...
   <!--  <div class="col-md-4 col-xs-12 col-sm-6 text-center col-md-offset-1 no-padd wid-40 margin">
    ...
    <div class="panel panel-default">
      ...
      <p><i class="fa fa-envelope-o" aria-hidden="true"></i>: <span class="<?php if(@$user[0]->email_verify=='N'){ echo 'not_verified';}?>" id="email"><?php echo @$user[0]->login_email;?> </span><?php if(@$user[0]->email_verify=='N'){?><a href="javascript:void(0)" onclick="verify_your_email('<?php echo @$user[0]->id; ?>')"><span id="v_email" class="verify_link">Verify</span></a><?php } ?></p>

      <p class="mb-30"><i class="fa fa-phone-square" aria-hidden="true"></i>: <span class="<?php if(@$user[0]->mob_verify=='N'){ echo 'not_verified';}?>" id="mobile"><?php echo @$user[0]->login_mob;?></span> <!-- <?php if(@$user[0]->mob_verify=='N'){?><a href=""><span id="v_mob" class="verify_link">Verify</span></a><?php } ?> --></p>
...
<ol>
     ...
     <input type="checkbox" name="agree" id="agree" value="1" class="form-control agreechk"><b class="agree_check">I understand all the rules and privacy policy of the examination.</b>
      ...
      <div class="modal-footer">
        ...
        <a href=""  class="btn btn-primary btn-lg" id="ready_exam">I am ready to begin</a>
          ...
          function verify_your_email(user_id)
            ...
            var base_url=$("#baseurl").val();
               ...
               // alert(base_url);
                ...
                $.ajax({
                                 ...
                                 url:base_url+'index.php/manage_user/send_email_verify',
...

                                 {
                                    ...
                                    var node='<div class="alert alert-success alert-dismissable"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Thank You!</strong> One Email has been sent to your email address.Check your email account and verify your email address.</div>';
...

  {
    ...
    var select_company = $('#select_company_'+id).val();

    var total_company = $('#total_company_'+id).val();
    ...
    { 
     ...
     $('#s_c_'+id).html('Select company');

   }

   else if(select_company.length > total_company)

   {

     $('#s_c_'+id).html('Check company selection');
...

   {
    ...
    $.ajax({
      ...
      url:'<?php echo base_url();?>plan/insert_cart',

      data:{id:id,company_id:select_company},
...

      {
        ...
        $.ajax({
          ...
          url:'<?php echo base_url();?>plan/count_cart',
        ...
        $.ajax({
          ...
          url:'<?php echo base_url();?>plan/detail_cart',
        ...
        $('html, body').animate({ scrollTop: $('#scroll_to_here').offset().top }, 'slow');
