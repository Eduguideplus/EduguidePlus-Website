                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="ed_dashboard_inner_tab">
                                        ...
                                        <form class="ed_tabpersonal" id="general_set" method="post" action="">
                                            <div class="form-group mt-btn-20">
                                    ...
                                    <div class="ed_dashboard_inner_tab">
                                        ...
                                        <p>If you want to deactivate your account,then click on the 'Deactivate' button.</p>
                                       
                                        <button class="readmore btn-danger pull-right" onclick="deactivate_my_account()">Deactivate</button>
                                    </div>
                                    </div>
    ...
    <div class="add-1">
      <a href="#"><img src="http://192.168.0.12/wbcsforum/site/assets/images/add-1.jpg" class="img-responsive"></a>
          ...
          function deactivate_my_account()
          {
            ...
            if (r == true)
            {
                window.location.href = "<?php echo $this->url->link(85); ?>" ;
            }
          }
          </script>