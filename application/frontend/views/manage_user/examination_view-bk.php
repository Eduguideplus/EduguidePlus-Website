...
<?php if(count(@$incomplete_exam)>0){?>
                          ...
                          <?php 
                           ...
                           <a href="javascript:void(0)" onclick="go_to_resume_exam('<?php echo @$ice->id; ?>','<?php echo @$set_id; ?>')" class="btn   <?php if(@$request_dtls[0]->status=='approved'){ echo 'btn-success'; }else{ echo 'btn-warning';}?> <?php if(@$ice->resume=='No'){echo 'disable-anchor';}?>" target="_blank"> Resume</a></td>
...
<!--End -->
    ...
    window.resizeTo(screen.width, screen.height - 100);
     examwindow.document.title = 'testing';
       ...
       examwindow.onload = function() { this.document.title = "P2Exam Online Examination"; }
