                                            ...
                                            <table id="profile_view_settings" class="table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $plan->plan_price;?></a></td>
                                                        ...
                                                        <td><?php if($current_date > $plan->validity_date) { ?>
                                        ...
                                        <h2 class="col-md-3">edit profile</h2>
                                         ...
                                         <div class="col-md-9" style="display:none;color:red;" id="err_msg"></div>
                                            ...
                                            <form class="ed_tabpersonal" name="profile" id="profile" >
                                                <div class="form-group mt-btn-10">
                                                ...
                                                <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Location" name="location1" id="location1" value="<?php echo @$user[0]->user_address;?>">
                                                </div>
                                                </div>
