                        ...
                        <div role="tabpanel">
                          <!-- Nav tabs -->
                                ...
                                <div class="col-sm-12">
                                    <div class="wallet-icon">
                                        <div class="icn-content">
                                            <img src="<?php echo base_url();?>assets/images/wallet.png" class="img-responsive" alt="">
                                        </div>
                                        <p>Your Wallet Balance <b>Rs: 3000</b></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 nopadding-right">
                                    <input type="text" class="form-control" placeholder="Enter Amount to Recharge">
                                </div>
                                </div>
                              ...
                              <div class="addmony">
                                  ...
                                  <form accept="#" method="post">
                                    <div class="walt-bx">
                                      ...
                                      <div class="col-md-4">
                                        <ul class="add-paytm-cash">
                                          <li><img src="assets/images/wallet.png" align="">


                                            <div class="wal-bx">
                                              <span class="value">Rs 1</span>
                                      ...
                                      <div class="col-md-5">
                                        <form class="my-10 register-form" action="" method="post" onsubmit="return false;">
                                          <div class="form-group row">
                                            <div class="col-12 mm-top">

                                              <div class="form-material form-material-primary input-group wid-100">

                                                <input type="email" class="form-control" id="message-email" name="message-email" placeholder="Enter Amount to be Added in Wallet">
                                      ...
                                      <div class="col-md-3">
                                        ...
                                        <div class="form-group mm-top">
                                          <button type="button" class="addmoney-btn wid-100">Add Money to Wallet
                                          </button>
