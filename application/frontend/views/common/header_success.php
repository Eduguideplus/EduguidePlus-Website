...
<meta name="description" content="<?php if($meta_description !=""){ echo strip_tags(@$meta_description); }else{ "Surajit Pramanick";} ?>" />

  <meta property="og:title" content="<?php if($title !=""){ echo  $title; }else{ "Surajit Pramanick";} ?>" />
<meta property="og:description" content="<?php if($meta_description !=""){ echo  strip_tags(@$meta_description); }else{ "Surajit Pramanick";} ?>" />
<?php
        if($data['page_id'] == 151)
            {
                ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-xs-8">
                <div class="top_header_left">
                  <ul>
                    <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>+91 80131 43112</li>
                    <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a>eduguideplus@gmail.com</li>
                  </ul>
                </div>
              </div>
         ...
         <div class="container">
          <div class="row">
            <div class="col-md-2 col-xs-3 col-sm-3">
             <div class="header-bg"> 
           <div class="logo">
            <a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/images/eduguide-logo01.png" class="img-responsive" alt=""></a>
          </div>
              ...
              <!-- </li> -->
                ...
                <!-- <li><a href=""> Signout </a></li> -->
                  ...
                  <?php if($this->session->userdata('activeuser')==''){ ?>
                   ...
                   <!-- <li class="dropdown">
                    <a href="<?php echo $this->url->link(86); ?>"> Login / Sign Up </a>
