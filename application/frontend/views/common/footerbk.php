    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 res-ft-height wid-33">
     ...
     <ul class="list-group">
      ...
      <li><a href="#">Courses</a></li>
       <li><a href="<?php echo @$this->url->link(75); ?>">Blank<?php /*$total_attm=@$total_attempt;
...
jQuery("#pie").radialPieChart("init", {
  ...
  'data': [
    ...
    {'color': "yellow", 'perc': <?php echo $ong_percent; ?>},
...
jQuery("#pie2").radialPieChart("init", {
  ...
  'data': [
    ...
    {'color': "#A4075E", 'perc': <?php echo $not_ans_percent; ?>}
  ]
});
