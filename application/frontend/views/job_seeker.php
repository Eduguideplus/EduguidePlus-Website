...
<section class="job_seekar">
    <div class="container">
     ...
     <li class="nav-item">
      <a class="nav-link active" data-toggle="pill" href="#home" ><i class="fa fa-globe" aria-hidden="true"></i> Current Opening</a>
    </li>
...
<div id="home" class="container tab-pane active">
     <?php    $job_details=$this->common_model->common($table_name = 'tbl_career', $field = array(), $where = array('status'=>'active'), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');

      foreach ($job_details as $key=>$row) {  ?>
      <div class="jobs text-left">
                                   
                                    <h5><?php echo $row->job_title; ?>  <a class="btn btn-info btn-lg pull-right" data-toggle="modal" onclick="apply(<?php echo $row->job_alert_id; ?>,'<?php echo $row->job_title; ?>');">Apply</a></h5>
                                    <div class="col-md-11">
                                        <p><b>Work Location :</b> <?php echo $row->work_location; ?>
                                            <br>
                                            <b>Vacancy :</b> <?php echo $row->vacancy; ?>
                                            <br>
                                            <strong>Qualification :</strong> <?php echo $row->requisite_qualification; ?>
                                            <br>
...
echo $row->job_requirment; ?>  
                                        <br>
                                       <!--  <div class="details<?php echo $key+1; ?>" style="display: none;">
                                           <?php echo $row->job_requirment; ?>


                                        </div>  -->
<!--                                         <a class="show<?php echo $key+1; ?> show-btn">Expand to Read More &gt;</a>
 -->                                    </div>
                                </div>
          ...
          <form method="post" id="career_id"  class="field_form" action="<?php echo base_url(); ?>index.php/Manage_career/career_email" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.8s" style="animation-delay: 0.8s; opacity: 1;">
                                    <input type="text" placeholder="Enter Subject" id="subject" class="form-control" name="subject" readonly="">
                                </div>
