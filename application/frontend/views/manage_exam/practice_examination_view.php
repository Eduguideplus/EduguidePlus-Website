...
<div class="container_element">
   ...
   <?php foreach(@$pattern as $pt){?>
    <a href="javascript:void(0)" onclick="get_section_question('<?php echo @$set_id; ?>','<?php echo $pt->section_id; ?>')"><div class="box"><?php echo @$pt->section_name; ?></div></a>
    <?php } ?>
...
foreach(@$pattern as $pt){?>
            ...
            <a href="javascript:void(0)" onclick="get_section_question('<?php echo @$set_id; ?>','<?php echo $pt->section_id; ?>')"><span class="subject subjecttab" id="">
...
foreach(@$pattern as $pt){
    ...
    if($pt->section_id!=3)
    {
        ...
        $exm_qstn=$this->join_model->get_question_of_section($set_id,$pt->section_id);
        ?>
        <h3 class="acrdnhdr"><?php echo $pt->section_name; ?></h3>
            <div>
                <div style="display:inline-block;width:100%">
                    ...
                    ?>
                        <a href="javascript:void(0)" onclick="get_single_question('<?php echo @$qs_id; ?>','<?php echo $pt->section_id; ?>','<?php echo $i;?>','<?php echo $set_id;?>')"><li class="questionnumb unattempted" id="q_<?php echo @$qs_id; ?>"><?php echo $i;?></li></a>
...
setInterval(function () {
    ...
    var base_url='<?php echo base_url(); ?>';
     ...
     $.ajax(
                ...
                data:{min:min, sec:sec, setid:set, exmid:exam_id},
                async: false,
    ...
    document.getElementById('countdown2').innerHTML = timestamp.getMinutes() + 'm:' + timestamp.getSeconds() + 's';
 ...
 var r = confirm("Are you sure about submitting test?");
	...
	//alert(user_exam_id);
	  ...
	  $.ajax(
                        ...
                        url:base_url+'index.php/manage_exam/complete_examination_show_result',
