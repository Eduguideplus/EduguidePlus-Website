            ...
            <div class="inrhdr">
              <span class="logo"><img src="<?php echo base_url().'assets/images/admin-logo.png';?>"></span> 
               ...
               <!-- <div class="ex-title text-center">
                ...
                <span class="profile">
                    <span class="profileimg"><img src="<?php if(@$user_details[0]->profile_photo!=''){echo base_url().'assets/uploads/student_pic/'.@$user_details[0]->profile_photo; }else{echo base_url().'assets/images/profile.jpg';}?>"></span>
                    ...
                    <span><?php echo date('jS M Y',strtotime(@$set_dtls[0]->exam_date)); ?> <?php echo @$set_dtls[0]->exam_time;
                                                                $time_arr=explode(':',@$set_dtls[0]->exam_time);
                                                                ?></span> 
