...
<body>
    ...
    <header>
        <div class="wrapper">
            <div class="inrhdr">
                ...
                <span class="logo"><img src="<?php echo base_url().'assets/images/logo2.png';?>"></span> 
    ...
    <span class="exam-bar" style="font-size:30px;cursor:pointer" onclick="openNav()"><i class="fa fa-bars" aria-hidden="true"></i></span>
          ...
          <div class="headnav"><a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a></div>
...
foreach(@$pattern as $pt){
    ...
    if($pt->section_id!=3)
    {
        ...
        ?>
        <h3 class="acrdnhdr mobpelete"><?php echo $pt->section_name; ?></h3>
            <div>
                <div style="display:inline-block;width:100%">
                    ...
                    for($i=1;$i<=$pt->quantity;$i++)
                    {
                        $qs_id=@$exm_qstn[$qs_count]->question_id;
                         ...
                         $attempted_question=$this->common_model->common($table_name = 'tbl_user_exam_details', $field = array(), $where = array('user_exam_id'=>@$user_exam,'question_master_id'=>@$qs_id,'is_review'=>'No'), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
         ...
         <h3 class="acrdnhdr"><?php echo $pt->section_name; ?></h3>
            <div>
                <div style="display:inline-block;width:100%">
                    ...
                    ?>
                        <a href="javascript:void(0)" onclick="get_single_passage_question_resume('<?php echo @$qs_id; ?>','<?php echo $pt->section_id; ?>','<?php echo $i;?>','<?php echo @$psg_id; ?>','<?php echo $set_id[0];?>')"><li class="questionnumb <?php if(count(@$attempted_question)>0){if(count(@$reviewed_question)>0){echo 'review';}else{echo 'attempted';}}else{ echo 'unattempted'; }?>" id="qmob_<?php echo @$qs_id; ?>"><?php echo $i;?></li></a>
...
<div class="submit ">
    ...
    <a href="javascript:void(0);" class="submitbtn" onclick="submit_examination_resume()">Submit test</a>
</div>
</div>
</div>
          <!-- <a href="#">About</a>
...
<div class="container_element">
   ...
   <?php foreach(@$pattern as $pt){?>
    <a href="javascript:void(0)" onclick="get_section_question_resume('<?php echo @$set_id[0]; ?>','<?php echo $pt->section_id; ?>')"><div class="box"><b><?php echo @$pt->section_name; ?></b></div></a>
    <?php } ?>
    <!--<a href="#"><div class="box">Efgh</div></a>
    <a href="#"><div class="box">Pqrs</div></a>
    <a href="#"><div class="box">stuv</div></a>
    <a href="#"><div class="box">fwsafsgf</div></a>
    <a href="#"><div class="box">sdahfsdj</div></a>
    <a href="#"><div class="box">hsdfiuhghsghsghh</div></a>-->
    </div>
</div>
<div id="righty">&gt;</div>
</nav>
...
foreach(@$pattern as $pt){?>
            ...
            <a href="javascript:void(0)" onclick="get_section_question_resume('<?php echo @$set_id[0]; ?>','<?php echo $pt->section_id; ?>')"><span class="subject subjecttab" id="">
...
<div class="subject language" id="languagedrop">
    ...
    <div id="timer" class="timer-quick"><?php echo @$min_val;?></div>
    <input type="hidden" name="hid_duration" id="hid_duration" value="<?php echo @$min_val;?>">
...
<input type="hidden" name="hid_se" id="hid_se" value="<?php echo @$qstn[0]->section_id; ?>">
        <div class="quehdng">
        ...
        <div id="about" class="nano questionoutr" style="display:block">
            <div class="nano-content">
                ...
                <div class="questioninr">
                    ...
                    $attempted_question=$this->common_model->common($table_name = 'tbl_user_exam_details', $field = array(), $where = array('user_exam_id'=>@$user_exam,'question_master_id'=>@$q_id,'is_review'=>'No'), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');

                        $reviewed_question=$this->common_model->common($table_name = 'tbl_user_exam_details', $field = array(), $where = array('user_exam_id'=>@$user_exam,'question_master_id'=>@$q_id,'is_review'=>'Yes'), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
                   ...
                   for($a=0;$a<count(@$answr);$a++){
                    ...
                    ?>
                        ...
                        <input id="radio<?php if($a>0){ echo $a; }?>" class="radiobtn" name="radio" type="radio" value="<?php echo $a+1; ?>" <?php if(@$answr[$a]->id== @$attempted_question[0]->selected_choice || @$answr[$a]->id== @$reviewed_question[0]->selected_choice){echo 'checked'; }?>>
...
<div class="footrlft">
   <!--  <a class="arrow_slide" href="javascript:void(0);"><span class="angle1"></span></a> -->
    <a class="arrow_slide2" id="save" href="javascript:void(0);" onclick="save_get_next_question_resume('<?php echo @$exam; ?>','<?php echo @$set_id; ?>','<?php echo @$qstn[0]->section_id;?>','<?php echo  @$q_id; ?>')">SAVE & NEXT &nbsp;<span class="angle2"></span></a>
        ...
        <h3 class="acrdnhdr"><?php echo $pt->section_name; ?></h3>
            <div>
                <div style="display:inline-block;width:100%">
                    ...
                    ?>
                        <a href="javascript:void(0)" onclick="get_single_question_resume('<?php echo @$qs_id; ?>','<?php echo $pt->section_id; ?>','<?php echo $i;?>','<?php echo $set_id[0];?>')"><li class="questionnumb <?php if(count(@$attempted_question)>0){if(count(@$reviewed_question)>0){echo 'review';}else{echo 'attempted';}}else{ echo 'unattempted'; } ?>" id="q_<?php echo @$qs_id; ?>"><?php echo $i;?></li></a>
...
<script>
function get_section_question_resume(set_id,section_id)
{
    ...
    var base_url='<?php echo base_url(); ?>';
                ...
                url:base_url+'index.php/manage_resume_exam/get_question_by_section',
                ...
                success: function (data) {
                            ...
                            var q_id=$("#hid_q").val();
                            var node='save_get_next_question_resume('+e_id+','+s_id+','+se_id+','+q_id+')';
...
<script>
function get_single_question_resume(question_id,section_id,question_no,set_id)
{
    var sections=$("#num_pattern").val();
    var sec_array = sections.split(',');
     ...
     var base_url='<?php echo base_url(); ?>';
                ...
                url:base_url+'index.php/manage_resume_exam/get_single_question',
...
<script>
function get_single_passage_question_resume(question_id,section_id,question_no,passage_id,set_id)
{
    ...
    var prev_se=$("#hid_se").val();
     ...
     var base_url='<?php echo base_url(); ?>';
                ...
                url:base_url+'index.php/manage_resume_exam/get_single_passage_question',
...
function countdown(minute,second) {
   ...
   var base_url='<?php echo base_url(); ?>';
     ...
     $.ajax(
                ...
                url:base_url+'index.php/manage_resume_exam/set_timer_update',
        ...
        else 
        {
            ...
            if(mins > 1)
            {
               ...
               setTimeout(function () { countdown(mins-1,seconds); }, 1000);
            ...
            else
            {
                ...
                if(mins==0)
                {
                  //ert('ok');
                    //$("#examover").modal('show');
                    openDialog($('#content'));
                    var node='go_to_result_resume('+exam_id+','+set+')';
                     $('#exam_score').attr('onclick', node);

                    var endtm='<?php echo date("Y-m-d H:i:s");?>';
                    //var uplan_id=$("#hid_user_plan").val();
                        ...
                        url:base_url+'index.php/manage_resume_exam/complete_examination',
...
<script>
function save_get_next_question_resume(exam_id,set_id,section_id,question_id)
{
    //alert(section_id);
    ...
    var sec_array = sections.split(',');
     var base_url='<?php echo base_url(); ?>';
                ...
                url:base_url+'index.php/manage_resume_exam/save_next_question',
                ...
                success: function (data) {
                            ...
                            var reviewed_arr = reviewed.split(',');
                              ...
                              for(var q=0;q<reviewed_arr.length;q++)
                                ...
                                //var prev_se_id=$("#hid_se_prev").val();
                                 for(var i=0;i<sec_array.length;i++)
                            {
...
function go_to_result_resume(user_exam,set_id)
{
  //alert('ok');
  ...
  $.ajax(
                        ...
                        url:base_url+'index.php/manage_resume_exam/get_score_link',
...
<script>
function submit_examination_resume()
{ 
 ...
 var r = confirm("Are you sure about submitting test?");
    if (r == true) 
    {
        $.ajax(
                        ...
                        url:base_url+'index.php/manage_resume_exam/complete_examination_show_result',
                        data:{setid:set,exmid:user_exam_id,endtime:endtm},
                        async: false,
                      ...
                      scorewindow.onload = function() { this.document.title = "Examination Summary"; }
