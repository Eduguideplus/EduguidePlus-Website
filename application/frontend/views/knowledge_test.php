 ...
 <div class="row">
  <div class="container main-container-home">
  		<div class="col-md-12 col-sm-12 col-xs-12 text-center log-in">
  			<h3>welcome to Knowledge Test<!-- <br> Take a Test --></h3>
  		</div>
            ...
            $.ajax(
                {
                    type: "POST",
                    dataType:'json',
                    url:"<?php echo base_url();?>index.php/Knowledge_test/check_current_option",
            ...
            $.ajax(
                {
                    type: "POST",
                    dataType:'json',
                    url:"<?php echo base_url();?>index.php/Knowledge_test/get_exam",
            ...
            $.ajax(
                {
                    type: "POST",
                    dataType:'json',
                    url:"<?php echo base_url();?>index.php/Knowledge_test/get_subjects",
                    data: {category_id: value},
                    async: false,
                    success: function(data)
                    {
            ...
            $.ajax(
                {
                    type: "POST",
                    dataType:'html',
                    url:"<?php echo base_url();?>index.php/Knowledge_test/get_mock_question_list",
