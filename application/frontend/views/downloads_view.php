  ...
  <div class="container main-container-home">
  		...
  		<div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2">
            ...
            <div class="courses-block library-list">
              ...
              <td><a  href="<?php echo base_url(); ?>assets/uploads/downloads/<?php echo $row->material_file; ?>" download ><img src="<?php echo base_url(); ?>assets/images/download1.png" class="pdf-down"></a></td>
            </tr>
              </table>
            </div>
