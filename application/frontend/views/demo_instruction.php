...
<div class="container-fluid login_register deximJobs_tabs practice instruction_section">
 ...
 <div class="row">
  ...
  <div class="container main-container-home">
  			...
  			<div class="rank-bx about-exam">
  				...
  				<div class="col-md-5 col-sm-4 col-xs-12">
  					...
  					<div class="about-exam-bx">
  						...
  						<img src="<?php echo base_url(); ?>assets/images/exam02.jpg" alt="" class="img-responsive">
      ...
      <div id="ready_to_big_false text-left" class="start_lft">  <a onclick="get_exam();" class="btn btn-success">Start Test Now<i class="fa fa forward" ></i> </a></div> 

       <div id="ready_to_big_false" class="start_rht">  <a href="<?php echo $this->url->link(131); ?>" class="btn btn-danger"><i class="fa fa backward"></i> Back</a></div>    
