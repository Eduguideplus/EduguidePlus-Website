...
$user_plan=$this->common_model->common($table_name = 'tbl_user_plan', $field = array(), $where = array('user_id'=>$usr,'plan_id'=>5), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
...
$user_knowledge_quiz=$this->common_model->common($table_name = 'tbl_user_knowledge_quiz', $field = array(), $where = array('user_id'=>$usr,'set_id'=>$sl->kq_id,'user_plan_id'=>@$user_plan[0]->id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
...
$user_exam=$this->common_model->common($table_name = 'tbl_user_exam', $field = array(), $where = array('user_id'=>$usr,'set_id'=>$sl->kq_id,'user_plan_id'=>@$user_plan[0]->id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
  ...
  ?>
  			<div class="col-md-4 col-sm-6 col-xs-12">
  				<div class="test-cnt">
  					...
  					<ul>
                <?php if(count(@$user_knowledge_quiz)==0 || count($user_plan)==0 || $usr==""){ ?>
...
<?php if(count(@$user_knowledge_quiz)==0 || count($user_plan)==0 || $usr==""){ ?>
  ...
  <div id="ready_to_big_false" style="display: none">  <a onclick="false_go();" class="btn btn-success">Start Exam Now <i class="fa fa forward" ></i> </a></div>
   ...
   <?php if(@count($user_exam)==0 && @count($total_examiner)>1 ){ ?>
...
<?php }if(@count($user_exam)>0 || @count($total_examiner)<=1 ){ ?>
 ...
 <div >  <a class="btn btn-success">Thank You <i class="fa fa forward" ></i> </a></div>
