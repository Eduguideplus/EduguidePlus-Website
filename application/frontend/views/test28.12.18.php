  ...
  ?>
  			<div class="col-md-4 col-sm-6 col-xs-12">
  				<div class="test-cnt">
  					...
  					<ul>
                <?php if(@$user_knowledge_quiz[0]->status!='enrolled' || count($user_plan)==0 || $usr==""){ ?>
...
<?php if(@$user_knowledge_quiz[0]->status!='enrolled' || count($user_plan)==0 || $usr==""){ ?>
        ...
        if($sl->reg_start_date <= date('Y-m-d') ){  ?>
   ...
   <br>         
 <div id="ready_to_big" style="display: none ; cursor: pointer">  <a href="<?php echo $this->url->link(117).'/'.@$sl->set_slug;?>" class="btn btn-success">Read Instruction <i class="fa fa forward" ></i> </a></div>
