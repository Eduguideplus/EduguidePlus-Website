 ...
 <div class="row">
  <div class="container main-container-home">
  		<div class="col-md-12 col-sm-12 col-xs-12 text-center log-in practice-bx">
  			<h3><?php echo @$set_dtls[0]->set_name;?></h3>
...
/*for($i=0;$i<count($option_details);$i++)
{
  if($option_details[$i]->is_correct=='Yes')
  {
    $correct_
  }
}*/
                  ...
                  <div class="quaton-bx">
                      <h4>Question: <?php echo $counter;?></h4>
                        <div class="setup">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" >
                                <div class="hints text-center " id="hint<?php echo @$q_details[0]->id; ?>">
                                      <h5>Hints</h5>
