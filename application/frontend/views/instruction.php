...
<div class="container-fluid login_register deximJobs_tabs practice instruction_section">
 <div class="row">
  <div class="container main-container-home">
  		...
  		<div class="col-md-12 col-sm-12 col-xs-12">
  			<div class="rank-bx about-exam">
  				...
  				<div class="col-md-7 col-xs-12 col-sm-8">
                    ...
                    <li><p>This mock test has 15 questions of 1 marks each and time allotted 30 minutes</p></li>
                    ...
                    <li><p>System will not will keep history of your practice, if you didn’t answer 100% in Chapter wise set.</p></li>
                    <li><p>Only after successful completion of this exam you will be allowed to next chapter, starting from chapter 1. Else you have to re-appear.</p></li>
                    <li><p>All the best for your examination!</p></li>
      ...
      <div id="ready_to_big_false text-left" class="start_lft">  
       <?php
