...
<ol class="carousel-indicators">
 <?php foreach( $our_experties_list as $key22=>$row){
  ?>
  <li data-target="#quote-carousel" data-slide-to="<?php echo $key22; ?>" <?php if(@$key22==0){?> class="active" <?php } ?>></li>
  <?php
}
?>
...
<!-- Quote 1 -->
 ...
 <?php 
          ...
          if(count(@$our_experties_list)>0){

          foreach( $our_experties_list as $key22=>$row){?>


<div <?php if(@$key22==0){?>  class="item active"  <?php } else{?> class="item" <?php }?> >
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="round-image">
        <?php if(@$row->image !=''){?>
        <img src="<?php echo base_url(); ?>assets/uploads/our_experties/<?php echo @$row->image;?>" alt="Photo"> <?php } else{?>
            ...
            $ii++;?>
                      ...
                      <li>
                        ...
                        <div class="latest_news_content">
                          <?php echo @$row->description;?> <?php if(@$row->is_new=='Yes'){?><p><span class="blink">New</span> <?php }?> </p>
                          <?php if(@$row->image!=''){

                          ?><a href="<?php echo base_url();?>assets/uploads/news_notice/<?php echo @$row->image;?>" target="_blank">Download File</a><?php
                        }
                        ?>
                        </div>
          ...
          foreach( $events_list as $row){
            ...
            $jj++;?>
                       ...
                       <li>
                        ...
                        <div class="latest_news_content">
                          <?php echo @$row->description;?> <?php if(@$row->is_new=='Yes'){?><p><span class="blink">New</span> <?php }?> </p><?php if(@$row->image!=''){

                          ?><a href="<?php echo base_url();?>assets/uploads/event/<?php echo @$row->image;?>" target="_blank">Download File</a><?php
                        }
                        ?>
                        </div>
                        </li>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="downbload_app_cont">
              <h2>Download App</h2>
              <h4>Download through the link or Scan the QR Code</h4>
          ...
          <div class="col-md-6">
            <div class="downbload_app_img">
              <a href="https://play.google.com/store/apps/details?id=com.eduguide.education&hl=en_IN" target="_blank"><img src="assets/images/down1.png" alt="down1"></a>
              <img src="assets/images/down2.png" alt="down2">
              <div class="prcode">
                <img src="assets/images/qrcode.png" alt="down2">
              </div>
            </div>
          </div>
        </div>
