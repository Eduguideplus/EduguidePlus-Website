  			...
  			<?php $this->load->view('account_sidebar'); ?>
  			   ...
  			   <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 res480-pl-0 res480-pr-0 ">
                        ...
                        <div class="myaccount-field myaccount-widget">
                          ...
                          <h3 class="title mt-10">Claim Award</h3>
                       ...
                       <!--    <p>(Notification for last date of claim if users rank but not yet claim)</p> -->
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 res480-pl-0 res480-pr-0">
                              <div class="myprofile-field claim-field">
                                  ...
                                  <form action="<?php echo base_url();?>My_profile/claim_award_con" method="post" class="profile-form awerd-form awerd" id="dvPassport1">   
                                         <div class="row">
                          ...
                          <div class="form-group ">
                            ...
                            <select name="city" id="city" class="form-control">
                              <option value="">Select City</option>                            </select>
                                      ...
                                      <form action="<?php echo base_url();?>My_profile/claim_award_con" method="post" class="profile-form awerd-form awerd1" id="dvPassport">
