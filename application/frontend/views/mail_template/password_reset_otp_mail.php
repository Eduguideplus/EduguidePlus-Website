...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Notification From Eduguideplus</title>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://www.Surajit Pramanick.com/assets/images/admin-logo.png" width="241" style="max-width:241px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><strong><span style="font-size:24px"><span style="color:#FF0000">Password Reset Information</span></span></strong></div>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;" width="600">
	<tbody>
		...
		<tr>
			<td>Hi&nbsp;<span style="color:#FF0000"><?php echo @$mail_data['uname']; ?>!&nbsp;</span><br>
			 Your One Time Password(OTP) to reset password is <b><?php echo @$mail_data['uotp']; ?></b> .Enter OTP in the specified place and continue to reset your password.Please do not share this OTP code with anyone.This OTP is valid for 5 minutes only.</a><br>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
