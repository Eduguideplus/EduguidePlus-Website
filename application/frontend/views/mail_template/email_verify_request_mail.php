...
<head>
	...
	<title>Reply From EDUGUIDEPLUS</title>
																...
																<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																	<tbody><tr>
																		...
																		<td valign="top" class="mcnTextContent" >
																			...
																			Dear <?php echo @$mail_data['v_name']; ?>,<br>Your account has been created successfully.<br>Your given Details are :<br>
																				 <tr>
																			<td>&nbsp;&nbsp;&nbsp;</td>
																			</tr>
																			...
																			<!-- <tr>
																			<td> Password: <?php echo @$mail_data['v_password']; ?></td>
																			</tr> -->
