                                                                ...
                                                                <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                    <tbody><tr>
                                                                        <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                           ...
                                                                           <img src="<?php echo base_url();?>assets/images/admin-logo.png" width="150" style="max-width:150px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                    ...
                                                                    <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <h3><em>Dear Admin,</em><br>
                                                                                A student  have successfully completed examination,please check the details below:&nbsp;</h3>
                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                                    <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong>Student Name: <?php echo @$mail_data['uname']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody></table>
                                                                <!--[if mso]>
                                                            ...
                                                            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                                   ...
                                                                   <!--  <tbody><tr>
                                                                    ...
                                                                    <!-- <?php if($mail_data['upurpose']!=""){ ?>
                                                                    <tbody><tr>

                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">

                                                                            <strong>
                                                                                 Subject: <?php echo @$mail_data['upurpose']; ?> 
                                                                    ...
                                                                    <tbody><tr> -->
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong> Test Type: <?php echo @$mail_data['testtype']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                  <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong>Examination Code: <?php echo @$mail_data['test_code']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                      ...
                                                                      <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong>Subject Name: <?php echo @$mail_data['sub_name']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                                <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong>Total Marks: <?php echo @$mail_data['t_marks']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong> Marks Obtained : <?php echo @$mail_data['o_marks']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                    </table>
                                                                ...
                                                                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 1px solid #CCCCCC;">
                                                                  <tbody><tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <strong>Examination Code: <?php echo @$mail_data['umsg']; ?></strong>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody></table>
                                                                <!--
