...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Notification From Surajit Pramanick</title>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="<?php echo base_url(); ?>assets/images/admin-logo.png" width="241" style="max-width:241px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><strong><span style="font-size:24px"><span style="color:#FF0000">New Enquiry</span></span></strong></div>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;" width="600">
	<tbody>
		...
		<tr>
			<td>Dear&nbsp;<span style="color:#FF0000">Admin!&nbsp;</span><br>
			We have received new enquery form user. Please check the details below<br> Enquery Message : 	</b> (Sub : <?php echo @$mail_data['usubject']; ?>)

			<br><br><?php echo @$mail_data['umsg']; ?><br>
			<?php echo @$mail_data['uname']. ' <br>'.@$mail_data['uemail']?><br>  <?php echo @$mail_data['uphone']. ' <br>' ;?>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
