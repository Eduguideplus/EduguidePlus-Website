                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><strong><span style="font-size:24px"><span style="color:#FF0000">Email Verification</span></span></strong></div>
	...
	<tbody>
		...
		<tr>
			<td>Hi&nbsp;<span style="color:#FF0000"><?php echo @$mail_data['user_name']; ?>!&nbsp;</span><br>
			 You have successfully registered since <?php echo @$mail_data['created_on']; ?> and your email address is <?php echo @$mail_data['user_email']; ?>.<br> Please click on this link <?php echo $this->url->link(67).'/'.@$mail_data['verify_link']; ?> to verify your email address to utilise all benifits from <a href="<?php echo base_url(); ?>">P2Exam</a> . from P2Exam.<br>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
