...
<head>
	...
	<title>New Registration - EDUGUIDEPLUS</title>
																...
																<table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
																	<tbody><tr>
																		<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																			...
																			<img align="center" alt="" src="<?php echo base_url(); ?>assets/images/admin-logo.png" width="200" style="max-width:369px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
																...
																<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																	<tbody><tr>
																		...
																		<td valign="top" class="mcnTextContent" >
																			...
																			Dear Admin,<br>A new Registartion has been done from EDUGUIDEPLUS <br>Please check details given below:<br>
																			<tr>
																			<td>&nbsp;&nbsp;&nbsp;</td>
																			</tr>
																			<tr><td>Name: <?php echo @$mail_data['v_name']; ?></td></tr>
																			

																		

																			<tr>
																			<td>Email: <?php echo @$mail_data['v_email']; ?></td>
																			</tr>

																			<tr>
																			<td>Contact Number: <?php echo @$mail_data['phone_no']; ?></td>
																			</tr>
																			
																			<tr>	
																			<td>Date: <?php echo @$mail_data['v_date']; ?></td>
																			</tr>
																			<tr>	
																			<td>User Code: <?php echo @$mail_data['user_code']; ?></td>
																			</tr>
																		</td></tr>
																	</tr>
