...
<table style="width: 100%; float: left; border: 1px solid #000; padding:15px 25px 15px; box-sizing: border-box;" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			...
			<tr>
			    <td style="font-size: 14px; padding-bottom: 15px;">Exam Date and Time : <?php echo @date('d/m/Y',strtotime($mail_data['exam_date'])); ?> <?php echo @$mail_data['exam_time']; ?>  <?php $time_arr=explode(':',@$mail_data['exam_time']);if($time_arr[0]>=12){echo ' PM';}else{echo ' AM'; } ?></td>
			...
			<tr>
			    <td style="font-size: 14px; padding-bottom: 15px;">Rank Index : <?php echo @$mail_data['rank_index']; ?> </td>
                <td style="font-size: 14px; padding-bottom: 15px;">Total Examinee : <?php echo @$mail_data['number_of_contestant_for_quiz']; ?> </td>
...
<?php } ?>
      ...
      <td><?php if($row->is_correct=='Yes'){echo "1";}else{echo "-0.25";} ?></td>
     <!--  <td>58</td> -->
