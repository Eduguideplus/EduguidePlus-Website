...
<head>
	...
	<title>Registration Successfull From wbcsforum</title>
																...
																<table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
																	<tbody><tr>
																		<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																			...
																			<img align="center" alt="" src="<?php echo base_url(); ?>assets/image/logo.png" width="150" style="max-width:369px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
																...
																<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																	<tbody><tr>
																		...
																		<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																			...
																			<h3><em>Dear <?php echo @$mail_data['uemail']; ?>,</em><br>
																				We thankfully acknowledge your registration.Please verify email on clicking this link <a title="verify mail" href="<?php echo base_url().$this->url->slug(67).'/'.$time."/".'USER-0000-'.@$mail_data['unique_id'].'/'.$randstring; ?>">Verify your Email</a></h3>
