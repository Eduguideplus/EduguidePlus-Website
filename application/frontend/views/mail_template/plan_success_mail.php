																...
																<table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
																	<tbody><tr>
																		<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																			...
																			<img align="center" alt="" src="https://www.Surajit Pramanick.com/assets/images/admin-logo.png" width="200" style="max-width:369px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
																...
																<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																	<tbody><tr>
																		...
																		<td valign="top" class="mcnTextContent" >
																			...
																			Congratulation!.Plan has been activated to your Account.&nbsp;<br>Your given Details are :<br>
																				 <tr>
																			<td>&nbsp;&nbsp;&nbsp;</td>
																			</tr>
																			<tr><td>Plan Name: <?php echo @$mail_data['plan_name']; ?></td></tr>
																			<tr>

																		

																			<tr>
																			<td>Plan Code: <?php echo @$mail_data['plan_code']; ?></td>
																			</tr>

																			<tr>
																			<td> Plan Validity: <?php echo @$mail_data['plan_validity']; ?></td>
																			</tr>
																			
																		
																			<td>Plan Amount: <?php echo @$mail_data['plan_amount']; ?></td>
																			</tr>
																		</td></tr>
																	</tr>
																	<!-- <tr>
...
<a href="https://www.Surajit Pramanick.com/">www.Surajit Pramanick.com</a><br>
