...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Order Cancelled From P2Exam</title>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><strong><span style="font-size:24px"><span style="color:#FF0000">Cancelled order Information</span></span></strong></div>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;" width="600">
	<tbody>
		...
		<tr>
			<td>Hello&nbsp;<span style="color:#FF0000">Admin!&nbsp;</span><br>
			some of our potential user <?php echo @$mail_data['uname']; ?> has cancelled one order. Please check the details below<br> Order Id : 	</b> <?php echo @$mail_data['order_id']; ?><br><br>Total Amount:<?php echo @$mail_data['amount']; ?><br><br>Placed on:<?php echo @$mail_data['created_date']; ?>
			From:<br>
