                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><strong><span style="font-size:24px"><span style="color:#FF0000">Cancelled Order Confirmation</span></span></strong></div>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;" width="600">
	<tbody>
		...
		<tr>
			<td>Dear&nbsp;<span style="color:#FF0000"><?php echo @$mail_data['uname']; ?>!&nbsp;</span><br>
			 We thankfully acknowledge your request.Your order <?php echo @$mail_data['order_id']; ?> of amount <?php echo @$mail_data['amount']; ?> has been cancelled successfully.<br> From P2Exam<br>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
