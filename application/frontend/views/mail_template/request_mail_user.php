	...
	<tbody>
		...
		<tr>
			<td>Hi&nbsp;<span style="color:#FF0000"><?php echo @$mail_data['user_name']; ?>!&nbsp;</span><br>
			 You have successfully sent your request to resume Examination of <?php echo @$mail_data['set_name']; ?> under plan <?php echo @$mail_data['plan_name'].'(Validity:'.@$mail_data['plan_validity'].')'; ?>. from wbcsforum.<br>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
