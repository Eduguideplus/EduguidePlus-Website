...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Notification From wbcsforum</title>
	...
	<tbody>
		...
		<tr>
			<td>Hi&nbsp;<span style="color:#FF0000">Admin!&nbsp;</span><br>
			 One request to resume Examination of <?php echo @$mail_data['set_name']; ?> under plan <?php echo @$mail_data['plan_name'].'(Validity:'.@$mail_data['plan_validity'].')'; ?> has been arrived.Please check the details from <a href="<?php echo base_url(); ?>">wbcsforum. from wbcsforum.<br>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
