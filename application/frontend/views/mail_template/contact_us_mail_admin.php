...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 13px;" width="600">
	<tbody>
		...
		<tr>
			...
			We have received new enquery from user. Please check the details below<br> Enquery Message : 	</b> (Sub : <?php echo @$mail_data['usubject']; ?>)<br><br><?php echo @$mail_data['umsg']; ?><br>
			<?php echo @$mail_data['uname']. ', <br>'.@$mail_data['uemail'].', <br>'.@$mail_data['mob']; ?><br>
			&nbsp;</td>
		</tr>
	</tbody>
</table>
