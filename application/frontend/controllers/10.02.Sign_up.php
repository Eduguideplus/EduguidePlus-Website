	...
	public function student_registration()
	{
		...
		if($name!='' && $email!='' && $password!='' && $mobile!='' && $terms!='')
		{
			...
			$this->db->insert('tbl_user',$data_array);
			 ...
			 // $this->session->set_userdata('User', $insert_user_id);
...
{
	$usr=$this->session->userdata('step1user');
	if($usr!='')
	{
		$foot_data['social'] = $this->common_model->common($table_name = 'tbl_social_link', $field = array(), $where = array(), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');

          $data['user_dtls'] = $this->common_model->common($table_name = 'tbl_user', $field = array(), $where = array('id'=>$usr), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
		...
		$this->load->view('common/header');
		$this->load->view('registration_otp',$data);
		$this->load->view('common/footer',$foot_data);
	}
}
...
function get_city_by_state()
{
  $state_id= $this->input->post('state_id');
    ...
    $state_list= $this->common_model->common($table_name ='cities', $field = array(), $where = array('state_id'=>$state_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
